...
* [Gravitee.io API Management (⭐379)](https://github.com/gravitee-io/gravitee-api-management) ⭐ 380 | 🐛 53 | 🌐 Java | 📅 2026-02-16 - A lightweight, open-source platform offering flexible API governance, robust security, and straightforward configuration.
...
* [OpenAPI Generator (⭐25k)](https://github.com/OpenAPITools/openapi-generator) ⭐ 25,818 | 🐛 5,580 | 🌐 Java | 📅 2026-02-15 - Automate the creation of API client libraries, server stubs, documentation and config files with this powerful OpenAPI Spec tool.
...
* [OpenAPI Diff (⭐1k)](https://github.com/OpenAPITools/openapi-diff) ⭐ 1,052 | 🐛 85 | 🌐 Java | 📅 2026-01-26 - Compare OpenAPI specs with version control and visualize the differences in HTML or Markdown format.
...
* [Swagger UI (⭐28k)](https://github.com/swagger-api/swagger-ui) ⭐ 28,625 | 🐛 1,366 | 🌐 JavaScript | 📅 2026-02-13 - Offers an interactive, in-browser tool for visualizing and testing APIs directly from OpenAPI specifications.
* [Redoc (⭐25k)](https://github.com/Redocly/redoc) ⭐ 25,494 | 🐛 428 | 🌐 TypeScript | 📅 2026-02-07 - Delivers clean, modern documentation with advanced theming, multi-language support, and seamless integration.
* [Stoplight Elements (⭐2.3k)](https://github.com/stoplightio/elements) ⭐ 2,356 | 🐛 259 | 🌐 TypeScript | 📅 2026-02-12 - Provides modular, attractive UI components for building comprehensive API reference and tutorial documentation.
...
* [Zudoku (⭐456)](https://github.com/zuplo/zudoku) ⭐ 456 | 🐛 76 | 🌐 TypeScript | 📅 2026-02-16 - A customizable framework built on OpenAPI, focused on delivering exceptional developer experiences through quality documentation.
...
* [Traefik API Gateway (⭐61k)](https://github.com/traefik/traefik) ⭐ 61,656 | 🐛 764 | 🌐 Go | 📅 2026-02-13 - Combines Traefik Proxy, a fully declarative application proxy with enterprise-grade access control, distributed security, and premium integrations.
* [Kong API Gateway (⭐42k)](https://github.com/Kong/kong) ⭐ 42,774 | 🐛 130 | 🌐 Lua | 📅 2026-01-19 - A scalable, cloud-native gateway that simplifies API management through extensive plugin support and seamless microservices integration.
* [Apache APISIX (⭐16k)](https://github.com/apache/apisix) ⭐ 16,214 | 🐛 340 | 🌐 Lua | 📅 2026-02-13 - A high-performance, dynamic gateway featuring real-time traffic management and powerful plugin integrations.
* [Tyk API Gateway (⭐10k)](https://github.com/TykTechnologies/tyk) ⭐ 10,633 | 🐛 388 | 🌐 Go | 📅 2026-02-13 - An enterprise-grade, open-source gateway supporting REST, GraphQL, TCP, and gRPC with advanced rate limiting and analytics.
...
* [Envoy Gateway (⭐2.5k)](https://github.com/envoyproxy/gateway) ⭐ 2,513 | 🐛 617 | 🌐 Go | 📅 2026-02-16 - CNCF Envoy-based gateway with Gateway API, mTLS, JWT, and other built-ins.
...
* API clients
  * [Hoppscotch (⭐77k)](https://github.com/hoppscotch/hoppscotch) ⭐ 77,862 | 🐛 652 | 🌐 TypeScript | 📅 2026-02-15 - A lightweight, web-based API development tool offering real-time testing with an intuitive interface.
  * [Bruno (⭐40k)](https://github.com/usebruno/bruno) ⭐ 40,875 | 🐛 1,712 | 🌐 JavaScript | 📅 2026-02-14 - A fast, offline API client designed for git-friendly workflows and seamless testing.
  * [curl (⭐40k)](https://github.com/curl/curl) ⭐ 40,710 | 🐛 34 | 🌐 C | 📅 2026-02-15 - A versatile command-line tool for data transfer across multiple protocols, essential for quick API testing.
  * [Insomnia (⭐37k)](https://github.com/Kong/insomnia) ⭐ 37,937 | 🐛 808 | 🌐 TypeScript | 📅 2026-02-13 - A cross-platform client that streamlines API debugging and testing for both REST and GraphQL services.
  * [HTTPie (⭐37k)](https://github.com/httpie/httpie) ⭐ 37,558 | 🐛 241 | 🌐 Python | 📅 2024-12-17 - An intuitive CLI HTTP client that simplifies crafting API requests and inspecting responses.
  * [Yaak (⭐17k)](https://github.com/mountain-loop/yaak) ⭐ 17,840 | 🐛 15 | 🌐 TypeScript | 📅 2026-02-14 - A fast, privacy-first desktop API client for REST, GraphQL, WebSocket, Server-Sent Events, and gRPC with offline-first design, built with Tauri and React.
  ...
  * [posting (⭐11k)](https://github.com/darrenburns/posting) ⭐ 11,350 | 🐛 76 | 🌐 Python | 📅 2025-10-14 - A modern, terminal-based API client designed for efficient and seamless API interactions.
  * [xh (⭐7.5k)](https://github.com/ducaale/xh) ⭐ 7,582 | 🐛 38 | 🌐 Rust | 📅 2026-02-01 - A fast, friendly CLI HTTP client that reimplements HTTPie's design with improved performance, HTTP/2 support, and built-in curl translation.
  * [Requestly (⭐6.2k)](https://github.com/requestly/requestly) ⭐ 6,252 | 🐛 316 | 🌐 TypeScript | 📅 2026-02-15 - Lightweight Git-Friendly API Client Built for Modern Developers.
  ...
  * [curlie (⭐3.5k)](https://github.com/rs/curlie) ⭐ 3,583 | 🐛 22 | 🌐 Go | 📅 2025-12-07 - A modern, user-friendly frontend to curl that combines simplicity with powerful performance.
  ...
  * [Yaade (⭐1.9k)](https://github.com/EsperoTech/yaade) ⭐ 1,956 | 🐛 52 | 🌐 JavaScript | 📅 2025-09-08 - A self-hosted, collaborative API development environment designed for team sharing with multi-user support, persistent storage, and support for REST, WebSockets, and Markdown documentation.
...
* Testing tools and frameworks
  * [Grafana k6 (⭐29k)](https://github.com/grafana/k6) ⭐ 29,909 | 🐛 790 | 🌐 Go | 📅 2026-02-16 - Open-source, JS-scriptable load-testing tool for CI/CD.
  * [Hurl (⭐18k)](https://github.com/Orange-OpenSource/hurl) ⭐ 18,509 | 🐛 196 | 🌐 Rust | 📅 2026-02-16 - A command-line tool for running HTTP requests with plain text syntax, excellent for both API testing and CI/CD integration with support for chaining, capturing values, and comprehensive assertions.
  * [Keploy (⭐15k)](https://github.com/keploy/keploy) ⭐ 15,672 | 🐛 533 | 🌐 Go | 📅 2026-02-15 - A developer-centric API and integration testing tool that auto-generates tests and data-mocks from real traffic using eBPF, supporting any language without code changes.
  ...
  * [Artillery (⭐8.8k)](https://github.com/artilleryio/artillery) ⭐ 8,893 | 🐛 479 | 🌐 JavaScript | 📅 2026-02-15 - A complete load testing platform supporting HTTP, WebSocket, Socket.io, gRPC, and more, with cloud-native serverless scaling on AWS Lambda and Fargate.
  * [Karate (⭐8.7k)](https://github.com/karatelabs/karate) ⭐ 8,786 | 🐛 70 | 🌐 Java | 📅 2026-02-05 - A unified testing framework that merges API automation, mocking, and performance testing with simple, expressive syntax.
  ...
  * [ghz (⭐3.2k)](https://github.com/bojand/ghz) ⭐ 3,285 | 🐛 96 | 🌐 Go | 📅 2026-02-01 - A simple gRPC benchmarking and load testing tool with support for various load schedules, concurrency control, and detailed performance metrics.
  * [Schemathesis (⭐3k)](https://github.com/schemathesis/schemathesis) ⭐ 3,045 | 🐛 41 | 🌐 Python | 📅 2026-02-15 - A Python library for property-based testing of API schemas, ensuring reliability through robust edge-case detection.
...
* Mocking tools
  * [Mockoon (⭐8k)](https://github.com/mockoon/mockoon) ⭐ 8,069 | 🐛 67 | 🌐 TypeScript | 📅 2026-02-14 - A user-friendly tool for designing and running mock REST APIs with real-time simulation and easy setup.
  * [WireMock (⭐7.1k)](https://github.com/tomakehurst/wiremock) ⭐ 7,134 | 🐛 464 | 🌐 Java | 📅 2026-02-16 - A robust and flexible API mocking tool delivering reliable, real-time simulation for comprehensive testing.
  ...
  * [Hoverfly (⭐2.4k)](https://github.com/SpectoLabs/hoverfly) ⭐ 2,465 | 🐛 34 | 🌐 Go | 📅 2026-02-14 - A lightweight API simulation tool that enables rapid HTTP(S) service virtualization for efficient testing.
  ...
  * [Microcks (⭐1.8k)](https://github.com/microcks/microcks) ⭐ 1,809 | 🐛 63 | 🌐 Java | 📅 2026-02-15 - A Kubernetes-native tool for API mocking and testing that supports AsyncAPI, OpenAPI, and Postman Collections.
...
* [Debezium (⭐12k)](https://github.com/debezium/debezium) ⭐ 12,403 | 🐛 106 | 🌐 Java | 📅 2026-02-13 - Open-source distributed platform for change data capture that turns your existing databases into event streams for real-time data integration.
* [Maxwell's daemon (⭐4.2k)](https://github.com/zendesk/maxwell) ⭐ 4,233 | 🐛 265 | 🌐 Java | 📅 2026-02-04 - An open-source CDC tool for MySQL that reads database binlogs and streams row-level changes as JSON to systems like Kafka, Kinesis, or other destinations.
...
* [Airbyte (⭐20k)](https://github.com/airbytehq/airbyte) ⭐ 20,724 | 🐛 2,305 | 🌐 Python | 📅 2026-02-16 - Flexible, open-source data integration platform that builds ELT pipelines to move data from diverse sources to modern destinations.
* [Pentaho Data Integration (⭐8.3k)](https://github.com/pentaho/pentaho-kettle) ⭐ 8,309 | 🐛 53 | 🌐 Java | 📅 2026-02-16 - Intuitive, visual ETL tool that simplifies data ingestion, blending, and cleansing across multiple sources without heavy coding.
* [Apache NiFi (⭐5.9k)](https://github.com/apache/nifi) ⭐ 5,967 | 🐛 28 | 🌐 Java | 📅 2026-02-14 - Automated data integration tool with a visual interface that seamlessly extracts, transforms, and delivers data across systems.
* [Apache InLong (⭐1.4k)](https://github.com/apache/inlong) ⭐ 1,483 | 🐛 7 | 🌐 Java | 📅 2026-01-29 - One-stop, full-scenario integration framework for massive data that supports data ingestion, synchronization, and subscription with real-time ETL capabilities.
* [Estuary Flow (⭐876)](https://github.com/estuary/flow) ⭐ 876 | 🐛 134 | 🌐 C++ | 📅 2026-02-16 - Versatile, scalable platform that provides both real-time and batch data integration for ETL and ELT pipelines.
...
* [JSONata (⭐2.5k)](https://github.com/jsonata-js/jsonata) ⭐ 2,514 | 🐛 164 | 🌐 JavaScript | 📅 2025-11-06 - Lightweight query and transformation language for JSON data.
...
* [Apache Camel (⭐6.1k)](https://github.com/apache/camel) ⭐ 6,127 | 🐛 13 | 🌐 Java | 📅 2026-02-15 - Robust integration framework leveraging Enterprise Integration Patterns to seamlessly connect diverse systems and APIs.
* [Ballerina (⭐3.8k)](https://github.com/ballerina-platform/ballerina-lang) ⭐ 3,808 | 🐛 1,559 | 🌐 Ballerina | 📅 2026-02-16 - Innovative programming language designed for effortless creation and integration of network services and APIs.
* [Spring Integration (⭐1.6k)](https://github.com/spring-projects/spring-integration) ⭐ 1,619 | 🐛 99 | 🌐 Java | 📅 2026-02-15 - Extension of the Spring ecosystem that provides out-of-the-box integration capabilities using proven Enterprise Integration Patterns.
* [Frank!Framework (⭐154)](https://github.com/frankframework/frankframework) ⭐ 154 | 🐛 244 | 🌐 Java | 📅 2026-02-16 - Low-code Java messaging framework that simplifies system connectivity and data integration through configurable XML setups.
...
* [Apache Kafka (⭐31k)](https://github.com/apache/kafka) ⭐ 31,907 | 🐛 279 | 🌐 Java | 📅 2026-02-15 - Distributed, high-throughput system designed for real-time data streaming and fault-tolerant processing.
...
* [NATS (⭐19k)](https://github.com/nats-io/gnatsd) ⭐ 19,152 | 🐛 479 | 🌐 Go | 📅 2026-02-13 - Lightweight, high-performance messaging system ideal for microservices and cloud-native architectures.
* [EMQX (⭐15k)](https://github.com/emqx/emqx) ⭐ 15,929 | 🐛 233 | 🌐 Erlang | 📅 2026-02-16 - High-performance MQTT broker built for IoT and industrial applications, ensuring scalable message delivery.
...
* [RabbitMQ (⭐13k)](https://github.com/rabbitmq/rabbitmq-server) ⭐ 13,458 | 🐛 268 | 🌐 JavaScript | 📅 2026-02-13 - Popular open-source broker implementing AMQP, known for reliability, clustering, and ease-of-use.
* [Redpanda (⭐11k)](https://github.com/vectorizedio/redpanda) ⭐ 11,726 | 🐛 667 | 🌐 C++ | 📅 2026-02-15 - Kafka-compatible streaming platform that eliminates Zookeeper, delivering high performance and low latency.
* [Eclipse Mosquitto (⭐10k)](https://github.com/eclipse/mosquitto) ⭐ 10,627 | 🐛 708 | 🌐 C | 📅 2026-02-15 - Lightweight MQTT broker optimized for low-power devices with robust encryption and authentication.
* [Centrifugo (⭐9.9k)](https://github.com/centrifugal/centrifugo) ⭐ 9,957 | 🐛 24 | 🌐 Go | 📅 2026-02-13 - Scalable real-time messaging server that minimizes delay in delivering events to online users.
...
* [Apache ActiveMQ (⭐2.4k)](https://github.com/apache/activemq) ⭐ 2,416 | 🐛 65 | 🌐 Java | 📅 2026-02-15 - Open-source broker that implements JMS, enabling seamless conversion between synchronous and asynchronous messaging.
...
* [Apache Artemis (⭐1k)](https://github.com/apache/artemis) ⭐ 1,000 | 🐛 11 | 🌐 Java | 📅 2026-02-16 - A multi-protocol message broker, supporting various industry standard protocols such as AMQP 1.0, MQTT 3.1.1, MQTT 5, and STOMP.
* [LavinMQ (⭐859)](https://github.com/cloudamqp/lavinmq) ⭐ 860 | 🐛 113 | 🌐 Crystal | 📅 2026-02-13 - High-performance message queue server implementing AMQP 0-9-1 and MQTT protocols, built with Crystal for exceptional throughput and minimal resource usage.
...
* [n8n (⭐174k)](https://github.com/n8n-io/n8n) ⭐ 174,705 | 🐛 1,383 | 🌐 TypeScript | 📅 2026-02-16 - Open-source workflow automation tool with 400+ connectors, giving you full control over your data and integrations.
...
* [Apache Airflow (⭐44k)](https://github.com/apache/airflow) ⭐ 44,282 | 🐛 1,732 | 🌐 Python | 📅 2026-02-16 - Platform for programmatically creating, scheduling, and monitoring workflows, ideal for managing complex data pipelines.
* [Prefect (⭐21k)](https://github.com/PrefectHQ/prefect) ⭐ 21,607 | 🐛 1,061 | 🌐 Python | 📅 2026-02-16 - Modern, developer-friendly orchestration tool optimized for data pipelines and complex workflows.
* [Temporal (⭐18k)](https://github.com/temporalio/temporal) ⭐ 18,341 | 🐛 641 | 🌐 Go | 📅 2026-02-16 - Open-source workflow-as-code platform designed for building reliable, scalable, and fault-tolerant applications.
* [Argo Workflows (⭐16k)](https://github.com/argoproj/argo-workflows) ⭐ 16,453 | 🐛 1,373 | 🌐 Go | 📅 2026-02-16 - Container-native workflow engine designed for orchestrating parallel jobs in Kubernetes-based, cloud-native environments.
...
* [Activiti (⭐10k)](https://github.com/Activiti/Activiti) ⭐ 10,514 | 🐛 669 | 🌐 Java | 📅 2026-02-16 - Lightweight, Java-centric BPMN engine that efficiently executes business workflows with a focus on simplicity.
* [Cadence (⭐9.1k)](https://github.com/uber/cadence) ⭐ 9,176 | 🐛 190 | 🌐 Go | 📅 2026-02-13 - Fault-tolerant, stateful platform that reliably orchestrates long-running workflows and complex applications.
* [Flowable (⭐9k)](https://github.com/flowable/flowable-engine) ⭐ 9,086 | 🐛 387 | 🌐 Java | 📅 2026-02-13 - Compact, efficient set of open-source engines for automating and scaling enterprise workflows.
* [Elsa Core (⭐7.6k)](https://github.com/elsa-workflows/elsa-core) ⭐ 7,623 | 🐛 791 | 🌐 C# | 📅 2026-02-15 - .NET Core library that integrates seamlessly into any application to execute and manage workflows.
...
* [Bonita (⭐172)](https://github.com/bonitasoft/bonita-engine) ⭐ 172 | 🐛 0 | 🌐 Java | 📅 2026-02-13 - Open-source BPMN engine with a designer interface to build and automate complex business processes.
...
* [OpenAPI (ex.Swagger) (⭐30k)](https://github.com/OAI/OpenAPI-Specification) ⭐ 30,918 | 🐛 115 | 🌐 Markdown | 📅 2026-02-11 - A language-agnostic specification for creating RESTful APIs that enables both humans and machines to understand the capabilities of a service without the need for source code or documentation.
* [GraphQL (⭐14k)](https://github.com/graphql/graphql-spec) ⭐ 14,783 | 🐛 208 | 🌐 JavaScript | 📅 2026-02-11 - A sophisticated query language and runtime for building efficient APIs that empowers engineers to retrieve data from existing systems with ease.
...
* [AsyncAPI (⭐5k)](https://github.com/asyncapi/spec) ⭐ 5,092 | 🐛 39 | 🌐 JavaScript | 📅 2026-02-14 - An essential tool for developing Event-Driven Architectures (EDA) and enables engineers to build a better tooling ecosystem.
...
* [JSON Schema (⭐4.8k)](https://github.com/json-schema-org/json-schema-spec) ⭐ 4,850 | 🐛 62 | 🌐 JavaScript | 📅 2026-02-10 - A powerful tool for validating the structure of JSON data. JSON Schema enables developers to ensure that JSON data conforms to a specific structure, making it easier to process and manipulate.
