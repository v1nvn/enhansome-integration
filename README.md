...
* [WSO2 API Manager (⭐965)](https://github.com/wso2/product-apim) ⭐ 968 | 🐛 658 | 🌐 Java | 📅 2026-02-19 - A fully open-source API platform offering robust governance, flexible deployment, and community-driven innovation.
* [Gravitee.io API Management (⭐379)](https://github.com/gravitee-io/gravitee-api-management) ⭐ 382 | 🐛 66 | 🌐 Java | 📅 2026-02-18 - A lightweight, open-source platform offering flexible API governance, robust security, and straightforward configuration.
...
* [OpenAPI Generator (⭐25k)](https://github.com/OpenAPITools/openapi-generator) ⭐ 25,835 | 🐛 5,590 | 🌐 Java | 📅 2026-02-19 - Automate the creation of API client libraries, server stubs, documentation and config files with this powerful OpenAPI Spec tool.
* [Swagger Editor (⭐9.4k)](https://github.com/swagger-api/swagger-editor) ⭐ 9,418 | 🐛 31 | 🌐 JavaScript | 📅 2026-02-17 - Create, describe, and document your API with ease using this open source editor built specifically for OpenAPI-based APIs.
...
* [Spectral (⭐3k)](https://github.com/stoplightio/spectral) ⭐ 3,009 | 🐛 235 | 🌐 TypeScript | 📅 2026-02-13 - Detect and fix errors in your JSON/YAML files using this linter tool that supports OpenAPI 3.0 & 2.0 and AsyncAPI.
...
* [OpenAPI Style Validator (⭐232)](https://github.com/OpenAPITools/openapi-style-validator) ⭐ 233 | 🐛 31 | 🌐 Java | 📅 2025-11-17 - Ensure that your OpenAPI specs meet your organization's standards with this flexible and customizable style validator.
...
* [Swagger UI (⭐28k)](https://github.com/swagger-api/swagger-ui) ⭐ 28,628 | 🐛 1,366 | 🌐 JavaScript | 📅 2026-02-16 - Offers an interactive, in-browser tool for visualizing and testing APIs directly from OpenAPI specifications.
* [Redoc (⭐25k)](https://github.com/Redocly/redoc) ⭐ 25,501 | 🐛 429 | 🌐 TypeScript | 📅 2026-02-07 - Delivers clean, modern documentation with advanced theming, multi-language support, and seamless integration.
* [Stoplight Elements (⭐2.3k)](https://github.com/stoplightio/elements) ⭐ 2,357 | 🐛 260 | 🌐 TypeScript | 📅 2026-02-17 - Provides modular, attractive UI components for building comprehensive API reference and tutorial documentation.
...
* [Zudoku (⭐456)](https://github.com/zuplo/zudoku) ⭐ 458 | 🐛 66 | 🌐 TypeScript | 📅 2026-02-19 - A customizable framework built on OpenAPI, focused on delivering exceptional developer experiences through quality documentation.
...
* [Traefik API Gateway (⭐61k)](https://github.com/traefik/traefik) ⭐ 61,750 | 🐛 765 | 🌐 Go | 📅 2026-02-18 - Combines Traefik Proxy, a fully declarative application proxy with enterprise-grade access control, distributed security, and premium integrations.
* [Kong API Gateway (⭐42k)](https://github.com/Kong/kong) ⭐ 42,793 | 🐛 131 | 🌐 Lua | 📅 2026-01-19 - A scalable, cloud-native gateway that simplifies API management through extensive plugin support and seamless microservices integration.
* [Apache APISIX (⭐16k)](https://github.com/apache/apisix) ⭐ 16,221 | 🐛 345 | 🌐 Lua | 📅 2026-02-17 - A high-performance, dynamic gateway featuring real-time traffic management and powerful plugin integrations.
* [Tyk API Gateway (⭐10k)](https://github.com/TykTechnologies/tyk) ⭐ 10,635 | 🐛 393 | 🌐 Go | 📅 2026-02-18 - An enterprise-grade, open-source gateway supporting REST, GraphQL, TCP, and gRPC with advanced rate limiting and analytics.
* [Apache ShenYu (⭐8.7k)](https://github.com/apache/shenyu) ⭐ 8,770 | 🐛 154 | 🌐 Java | 📅 2026-02-15 - A Java-native gateway excelling in protocol conversion, service proxying, and comprehensive API governance.
...
* [Spring Cloud Gateway (⭐4.8k)](https://github.com/spring-cloud/spring-cloud-gateway) ⭐ 4,823 | 🐛 502 | 🌐 Java | 📅 2026-02-17 - Leverages the Spring ecosystem to deliver robust routing, filtering, and security for microservices.
* [KrakenD API Gateway (⭐2.5k)](https://github.com/devopsfaith/krakend-ce) ⭐ 2,547 | 🐛 31 | 🌐 Go | 📅 2026-02-18 - An ultra-high performance gateway with efficient middleware configuration, robust security, and seamless scaling.
* [Envoy Gateway (⭐2.5k)](https://github.com/envoyproxy/gateway) ⭐ 2,519 | 🐛 631 | 🌐 Go | 📅 2026-02-19 - CNCF Envoy-based gateway with Gateway API, mTLS, JWT, and other built-ins.
...
* [Gloo Edge (⭐150)](https://github.com/solo-io/gloo) ⭐ 150 | 🐛 2,388 | 🌐 Go | 📅 2026-02-18 - An Envoy Proxy–based gateway offering advanced traffic control, enhanced security, and observability for microservices ecosystems.
...
* API clients
  * [Hoppscotch (⭐77k)](https://github.com/hoppscotch/hoppscotch) ⭐ 77,879 | 🐛 656 | 🌐 TypeScript | 📅 2026-02-18 - A lightweight, web-based API development tool offering real-time testing with an intuitive interface.
  * [Bruno (⭐40k)](https://github.com/usebruno/bruno) ⭐ 40,960 | 🐛 1,728 | 🌐 JavaScript | 📅 2026-02-18 - A fast, offline API client designed for git-friendly workflows and seamless testing.
  * [curl (⭐40k)](https://github.com/curl/curl) ⭐ 40,803 | 🐛 41 | 🌐 C | 📅 2026-02-18 - A versatile command-line tool for data transfer across multiple protocols, essential for quick API testing.
  * [Insomnia (⭐37k)](https://github.com/Kong/insomnia) ⭐ 37,949 | 🐛 807 | 🌐 TypeScript | 📅 2026-02-17 - A cross-platform client that streamlines API debugging and testing for both REST and GraphQL services.
  ...
  * [Yaak (⭐17k)](https://github.com/mountain-loop/yaak) ⭐ 17,871 | 🐛 15 | 🌐 TypeScript | 📅 2026-02-19 - A fast, privacy-first desktop API client for REST, GraphQL, WebSocket, Server-Sent Events, and gRPC with offline-first design, built with Tauri and React.
  * [grpcurl (⭐12k)](https://github.com/fullstorydev/grpcurl) ⭐ 12,449 | 🐛 119 | 🌐 Go | 📅 2026-01-27 - A command-line tool for interacting with gRPC servers, enabling inspection and invocation of RPC methods with support for server reflection and protocol buffer files.
  * [posting (⭐11k)](https://github.com/darrenburns/posting) ⭐ 11,366 | 🐛 76 | 🌐 Python | 📅 2025-10-14 - A modern, terminal-based API client designed for efficient and seamless API interactions.
  * [xh (⭐7.5k)](https://github.com/ducaale/xh) ⭐ 7,590 | 🐛 40 | 🌐 Rust | 📅 2026-02-01 - A fast, friendly CLI HTTP client that reimplements HTTPie's design with improved performance, HTTP/2 support, and built-in curl translation.
  * [Requestly (⭐6.2k)](https://github.com/requestly/requestly) ⭐ 6,318 | 🐛 331 | 🌐 TypeScript | 📅 2026-02-19 - Lightweight Git-Friendly API Client Built for Modern Developers.
  ...
  * [SoapUI (⭐1.6k)](https://github.com/SmartBear/soapui) ⭐ 1,671 | 🐛 140 | 🌐 Java | 📅 2026-02-10 - A comprehensive open-source solution for testing both SOAP and REST web services with extensive automation features.
...
* Testing tools and frameworks
  * [Grafana k6 (⭐29k)](https://github.com/grafana/k6) ⭐ 29,928 | 🐛 793 | 🌐 Go | 📅 2026-02-18 - Open-source, JS-scriptable load-testing tool for CI/CD.
  * [Hurl (⭐18k)](https://github.com/Orange-OpenSource/hurl) ⭐ 18,514 | 🐛 193 | 🌐 Rust | 📅 2026-02-19 - A command-line tool for running HTTP requests with plain text syntax, excellent for both API testing and CI/CD integration with support for chaining, capturing values, and comprehensive assertions.
  * [Keploy (⭐15k)](https://github.com/keploy/keploy) ⭐ 15,687 | 🐛 542 | 🌐 Go | 📅 2026-02-18 - A developer-centric API and integration testing tool that auto-generates tests and data-mocks from real traffic using eBPF, supporting any language without code changes.
  * [Apache JMeter (⭐9.2k)](https://github.com/apache/jmeter) ⭐ 9,230 | 🐛 935 | 🌐 Java | 📅 2026-02-12 - A feature-rich tool for load testing and performance analysis across diverse web applications and services.
  * [Artillery (⭐8.8k)](https://github.com/artilleryio/artillery) ⭐ 8,894 | 🐛 478 | 🌐 JavaScript | 📅 2026-02-16 - A complete load testing platform supporting HTTP, WebSocket, Socket.io, gRPC, and more, with cloud-native serverless scaling on AWS Lambda and Fargate.
  ...
  * [Gatling (⭐6.8k)](https://github.com/gatling/gatling) ⭐ 6,864 | 🐛 25 | 🌐 Scala | 📅 2026-02-17 - A powerful load testing framework with a developer-friendly DSL that delivers detailed performance metrics.
  * [ghz (⭐3.2k)](https://github.com/bojand/ghz) ⭐ 3,288 | 🐛 96 | 🌐 Go | 📅 2026-02-01 - A simple gRPC benchmarking and load testing tool with support for various load schedules, concurrency control, and detailed performance metrics.
  * [Schemathesis (⭐3k)](https://github.com/schemathesis/schemathesis) ⭐ 3,048 | 🐛 41 | 🌐 Python | 📅 2026-02-18 - A Python library for property-based testing of API schemas, ensuring reliability through robust edge-case detection.
  ...
  * [Taurus (⭐2k)](https://github.com/Blazemeter/taurus) ⭐ 2,098 | 🐛 34 | 🌐 Python | 📅 2026-02-18 - An open-source automation framework that simplifies continuous testing with intuitive configuration and integration support.
...
* Mocking tools
  * [Mockoon (⭐8k)](https://github.com/mockoon/mockoon) ⭐ 8,076 | 🐛 67 | 🌐 TypeScript | 📅 2026-02-14 - A user-friendly tool for designing and running mock REST APIs with real-time simulation and easy setup.
  * [WireMock (⭐7.1k)](https://github.com/tomakehurst/wiremock) ⭐ 7,136 | 🐛 468 | 🌐 Java | 📅 2026-02-19 - A robust and flexible API mocking tool delivering reliable, real-time simulation for comprehensive testing.
  ...
  * [Prism (⭐4.8k)](https://github.com/stoplightio/prism) ⭐ 4,851 | 🐛 132 | 🌐 TypeScript | 📅 2026-02-18 - An open-source HTTP mock server that replicates API behavior for early testing and validation.
  ...
  * [Microcks (⭐1.8k)](https://github.com/microcks/microcks) ⭐ 1,810 | 🐛 63 | 🌐 Java | 📅 2026-02-17 - A Kubernetes-native tool for API mocking and testing that supports AsyncAPI, OpenAPI, and Postman Collections.
...
* MQ clients
  ...
  * [MQTT Explorer (⭐3.7k)](https://github.com/thomasnordquist/MQTT-Explorer) ⭐ 3,789 | 🐛 345 | 🌐 TypeScript | 📅 2026-02-14 - A detailed MQTT client delivering structured topic visualization and intuitive debugging.
...
* [Drools (⭐6.2k)](https://github.com/apache/incubator-kie-drools) ⭐ 6,220 | 🐛 89 | 🌐 Java | 📅 2026-02-18 - Open-source engine that supports advanced Decision Model and Notation (DMN) with Eclipse IDE integration for efficient rule development.
...
* [ZEN Engine (⭐1.5k)](https://github.com/gorules/zen) ⭐ 1,587 | 🐛 40 | 🌐 Rust | 📅 2026-02-11 - A cross-platform, open-source Business Rules Engine written in Rust that executes JSON Decision Models through interconnected graphs of decision tables, functions, and expressions.
* [OpenL Tablets (⭐189)](https://github.com/openl-tablets/openl-tablets) ⭐ 189 | 🐛 38 | 🌐 Java | 📅 2026-02-18 - Flexible open-source decision management system that simplifies defining and executing business rules and decision tables.
...
* [Debezium (⭐12k)](https://github.com/debezium/debezium) ⭐ 12,416 | 🐛 108 | 🌐 Java | 📅 2026-02-18 - Open-source distributed platform for change data capture that turns your existing databases into event streams for real-time data integration.
...
* [Airbyte (⭐20k)](https://github.com/airbytehq/airbyte) ⭐ 20,740 | 🐛 2,314 | 🌐 Python | 📅 2026-02-19 - Flexible, open-source data integration platform that builds ELT pipelines to move data from diverse sources to modern destinations.
* [Pentaho Data Integration (⭐8.3k)](https://github.com/pentaho/pentaho-kettle) ⭐ 8,310 | 🐛 55 | 🌐 Java | 📅 2026-02-19 - Intuitive, visual ETL tool that simplifies data ingestion, blending, and cleansing across multiple sources without heavy coding.
* [Apache NiFi (⭐5.9k)](https://github.com/apache/nifi) ⭐ 5,974 | 🐛 33 | 🌐 Java | 📅 2026-02-19 - Automated data integration tool with a visual interface that seamlessly extracts, transforms, and delivers data across systems.
...
* [Estuary Flow (⭐876)](https://github.com/estuary/flow) ⭐ 878 | 🐛 137 | 🌐 C++ | 📅 2026-02-18 - Versatile, scalable platform that provides both real-time and batch data integration for ETL and ELT pipelines.
...
* [JSONata (⭐2.5k)](https://github.com/jsonata-js/jsonata) ⭐ 2,516 | 🐛 165 | 🌐 JavaScript | 📅 2025-11-06 - Lightweight query and transformation language for JSON data.
...
* [Apache Camel (⭐6.1k)](https://github.com/apache/camel) ⭐ 6,132 | 🐛 16 | 🌐 Java | 📅 2026-02-18 - Robust integration framework leveraging Enterprise Integration Patterns to seamlessly connect diverse systems and APIs.
* [Ballerina (⭐3.8k)](https://github.com/ballerina-platform/ballerina-lang) ⭐ 3,808 | 🐛 1,557 | 🌐 Ballerina | 📅 2026-02-18 - Innovative programming language designed for effortless creation and integration of network services and APIs.
* [Spring Integration (⭐1.6k)](https://github.com/spring-projects/spring-integration) ⭐ 1,620 | 🐛 93 | 🌐 Java | 📅 2026-02-18 - Extension of the Spring ecosystem that provides out-of-the-box integration capabilities using proven Enterprise Integration Patterns.
* [Frank!Framework (⭐154)](https://github.com/frankframework/frankframework) ⭐ 153 | 🐛 238 | 🌐 Java | 📅 2026-02-19 - Low-code Java messaging framework that simplifies system connectivity and data integration through configurable XML setups.
...
* [Apache Kafka (⭐31k)](https://github.com/apache/kafka) ⭐ 31,968 | 🐛 287 | 🌐 Java | 📅 2026-02-19 - Distributed, high-throughput system designed for real-time data streaming and fault-tolerant processing.
* [NSQ (⭐25k)](https://github.com/nsqio/nsq) ⭐ 25,922 | 🐛 74 | 🌐 Go | 📅 2025-07-13 - Realtime distributed messaging platform designed to operate at scale, handling billions of messages per day with decentralized topology.
...
* [NATS (⭐19k)](https://github.com/nats-io/gnatsd) ⭐ 19,169 | 🐛 481 | 🌐 Go | 📅 2026-02-18 - Lightweight, high-performance messaging system ideal for microservices and cloud-native architectures.
* [EMQX (⭐15k)](https://github.com/emqx/emqx) ⭐ 15,935 | 🐛 231 | 🌐 Erlang | 📅 2026-02-19 - High-performance MQTT broker built for IoT and industrial applications, ensuring scalable message delivery.
* [Apache Pulsar (⭐15k)](https://github.com/apache/pulsar) ⭐ 15,100 | 🐛 1,644 | 🌐 Java | 📅 2026-02-18 - Versatile pub/sub and streaming platform offering scalable, low-latency messaging for modern applications.
* [RabbitMQ (⭐13k)](https://github.com/rabbitmq/rabbitmq-server) ⭐ 13,467 | 🐛 272 | 🌐 JavaScript | 📅 2026-02-19 - Popular open-source broker implementing AMQP, known for reliability, clustering, and ease-of-use.
* [Redpanda (⭐11k)](https://github.com/vectorizedio/redpanda) ⭐ 11,739 | 🐛 675 | 🌐 C++ | 📅 2026-02-19 - Kafka-compatible streaming platform that eliminates Zookeeper, delivering high performance and low latency.
* [Eclipse Mosquitto (⭐10k)](https://github.com/eclipse/mosquitto) ⭐ 10,636 | 🐛 712 | 🌐 C | 📅 2026-02-18 - Lightweight MQTT broker optimized for low-power devices with robust encryption and authentication.
* [Centrifugo (⭐9.9k)](https://github.com/centrifugal/centrifugo) ⭐ 9,966 | 🐛 23 | 🌐 Go | 📅 2026-02-18 - Scalable real-time messaging server that minimizes delay in delivering events to online users.
...
* [BlazingMQ (⭐3.1k)](https://github.com/bloomberg/blazingmq) ⭐ 3,135 | 🐛 88 | 🌐 C++ | 📅 2026-02-18 - Distributed message queuing system focused on efficiency and reliability for modern workflow needs.
* [ElasticMQ (⭐2.8k)](https://github.com/softwaremill/elasticmq) ⭐ 2,809 | 🐛 26 | 🌐 Scala | 📅 2026-02-15 - In-memory message queue with an Amazon SQS-compatible interface, offering stand-alone or embedded deployment with optional UI and queue persistence.
...
* [Apache ActiveMQ (⭐2.4k)](https://github.com/apache/activemq) ⭐ 2,416 | 🐛 67 | 🌐 Java | 📅 2026-02-18 - Open-source broker that implements JMS, enabling seamless conversion between synchronous and asynchronous messaging.
...
* [Apache Artemis (⭐1k)](https://github.com/apache/artemis) ⭐ 1,001 | 🐛 12 | 🌐 Java | 📅 2026-02-18 - A multi-protocol message broker, supporting various industry standard protocols such as AMQP 1.0, MQTT 3.1.1, MQTT 5, and STOMP.
* [LavinMQ (⭐859)](https://github.com/cloudamqp/lavinmq) ⭐ 862 | 🐛 116 | 🌐 Crystal | 📅 2026-02-18 - High-performance message queue server implementing AMQP 0-9-1 and MQTT protocols, built with Crystal for exceptional throughput and minimal resource usage.
* [Apache Qpid (⭐67)](https://github.com/apache/qpid-broker-j) ⭐ 67 | 🐛 18 | 🌐 Java | 📅 2026-01-28 - AMQP-compliant messaging tool with multi-language support for enterprise-grade message delivery.
...
* [n8n (⭐174k)](https://github.com/n8n-io/n8n) ⭐ 175,218 | 🐛 1,382 | 🌐 TypeScript | 📅 2026-02-19 - Open-source workflow automation tool with 400+ connectors, giving you full control over your data and integrations.
...
* [Apache Airflow (⭐44k)](https://github.com/apache/airflow) ⭐ 44,316 | 🐛 1,746 | 🌐 Python | 📅 2026-02-19 - Platform for programmatically creating, scheduling, and monitoring workflows, ideal for managing complex data pipelines.
* [Prefect (⭐21k)](https://github.com/PrefectHQ/prefect) ⭐ 21,631 | 🐛 1,056 | 🌐 Python | 📅 2026-02-19 - Modern, developer-friendly orchestration tool optimized for data pipelines and complex workflows.
* [Temporal (⭐18k)](https://github.com/temporalio/temporal) ⭐ 18,391 | 🐛 639 | 🌐 Go | 📅 2026-02-19 - Open-source workflow-as-code platform designed for building reliable, scalable, and fault-tolerant applications.
* [Argo Workflows (⭐16k)](https://github.com/argoproj/argo-workflows) ⭐ 16,457 | 🐛 1,371 | 🌐 Go | 📅 2026-02-19 - Container-native workflow engine designed for orchestrating parallel jobs in Kubernetes-based, cloud-native environments.
...
* [Activiti (⭐10k)](https://github.com/Activiti/Activiti) ⭐ 10,516 | 🐛 669 | 🌐 Java | 📅 2026-02-19 - Lightweight, Java-centric BPMN engine that efficiently executes business workflows with a focus on simplicity.
* [Cadence (⭐9.1k)](https://github.com/uber/cadence) ⭐ 9,186 | 🐛 193 | 🌐 Go | 📅 2026-02-18 - Fault-tolerant, stateful platform that reliably orchestrates long-running workflows and complex applications.
...
* [Elsa Core (⭐7.6k)](https://github.com/elsa-workflows/elsa-core) ⭐ 7,627 | 🐛 792 | 🌐 C# | 📅 2026-02-18 - .NET Core library that integrates seamlessly into any application to execute and manage workflows.
* [StackStorm (⭐6.4k)](https://github.com/StackStorm/st2) ⭐ 6,406 | 🐛 596 | 🌐 Python | 📅 2026-02-18 - Robust automation engine that combines sensors, triggers, and workflows to orchestrate complex IT processes.
...
* [Bonita (⭐172)](https://github.com/bonitasoft/bonita-engine) ⭐ 172 | 🐛 0 | 🌐 Java | 📅 2026-02-18 - Open-source BPMN engine with a designer interface to build and automate complex business processes.
...
* [OpenAPI (ex.Swagger) (⭐30k)](https://github.com/OAI/OpenAPI-Specification) ⭐ 30,930 | 🐛 113 | 🌐 Markdown | 📅 2026-02-16 - A language-agnostic specification for creating RESTful APIs that enables both humans and machines to understand the capabilities of a service without the need for source code or documentation.
* [GraphQL (⭐14k)](https://github.com/graphql/graphql-spec) ⭐ 14,784 | 🐛 209 | 🌐 JavaScript | 📅 2026-02-11 - A sophisticated query language and runtime for building efficient APIs that empowers engineers to retrieve data from existing systems with ease.
...
* [JSON:API (⭐7.6k)](https://github.com/json-api/json-api) ⭐ 7,679 | 🐛 150 | 🌐 CSS | 📅 2025-03-13 - A standardized specification for building APIs that simplifies the representation of resources, relationships, and metadata, making it easier for software engineers to create efficient APIs.
* [CloudEvents (⭐5.6k)](https://github.com/cloudevents/spec) ⭐ 5,685 | 🐛 19 | 🌐 Python | 📅 2026-02-12 -  A specification for describing event data in common formats to provide interoperability across services, platforms and systems.
* [AsyncAPI (⭐5k)](https://github.com/asyncapi/spec) ⭐ 5,096 | 🐛 39 | 🌐 JavaScript | 📅 2026-02-14 - An essential tool for developing Event-Driven Architectures (EDA) and enables engineers to build a better tooling ecosystem.
...
* [Standard Webhooks (⭐1.6k)](https://github.com/standard-webhooks/standard-webhooks) ⭐ 1,608 | 🐛 55 | 🌐 Java | 📅 2026-02-18 - Open source tools and guidelines for sending webhooks easily, securely, and reliably.
...
* [OpenMessaging (⭐290)](https://github.com/openmessaging/specification) ⭐ 290 | 🐛 5 | 📅 2023-07-26 - A cloud native, vendor-neutral open specification for distributed messaging.
...
* [JSON Schema (⭐4.8k)](https://github.com/json-schema-org/json-schema-spec) ⭐ 4,854 | 🐛 63 | 🌐 JavaScript | 📅 2026-02-10 - A powerful tool for validating the structure of JSON data. JSON Schema enables developers to ensure that JSON data conforms to a specific structure, making it easier to process and manipulate.
