...
* [Gravitee.io API Management (⭐377)](https://github.com/gravitee-io/gravitee-api-management) ⭐ 378 | 🐛 57 | 🌐 Java | 📅 2026-02-07 - A lightweight, open-source platform offering flexible API governance, robust security, and straightforward configuration.
...
* [OpenAPI Generator (⭐25k)](https://github.com/OpenAPITools/openapi-generator) ⭐ 25,759 | 🐛 5,576 | 🌐 Java | 📅 2026-02-07 - Automate the creation of API client libraries, server stubs, documentation and config files with this powerful OpenAPI Spec tool.
...
* [Swagger UI (⭐28k)](https://github.com/swagger-api/swagger-ui) ⭐ 28,610 | 🐛 1,365 | 🌐 JavaScript | 📅 2026-02-06 - Offers an interactive, in-browser tool for visualizing and testing APIs directly from OpenAPI specifications.
* [Redoc (⭐25k)](https://github.com/Redocly/redoc) ⭐ 25,472 | 🐛 425 | 🌐 TypeScript | 📅 2026-02-07 - Delivers clean, modern documentation with advanced theming, multi-language support, and seamless integration.
...
* [RapiDoc (⭐1.8k)](https://github.com/rapi-doc/RapiDoc) ⭐ 1,880 | 🐛 129 | 🌐 JavaScript | 📅 2026-01-21 - Produces highly customizable, interactive API documentation with responsive design and rich configuration options.
...
* [Zudoku (⭐443)](https://github.com/zuplo/zudoku) ⭐ 445 | 🐛 70 | 🌐 TypeScript | 📅 2026-02-06 - A customizable framework built on OpenAPI, focused on delivering exceptional developer experiences through quality documentation.
...
* [Traefik API Gateway (⭐61k)](https://github.com/traefik/traefik) ⭐ 61,488 | 🐛 741 | 🌐 Go | 📅 2026-02-05 - Combines Traefik Proxy, a fully declarative application proxy with enterprise-grade access control, distributed security, and premium integrations.
* [Kong API Gateway (⭐42k)](https://github.com/Kong/kong) ⭐ 42,697 | 🐛 131 | 🌐 Lua | 📅 2026-01-19 - A scalable, cloud-native gateway that simplifies API management through extensive plugin support and seamless microservices integration.
* [Apache APISIX (⭐16k)](https://github.com/apache/apisix) ⭐ 16,184 | 🐛 356 | 🌐 Lua | 📅 2026-02-06 - A high-performance, dynamic gateway featuring real-time traffic management and powerful plugin integrations.
* [Tyk API Gateway (⭐10k)](https://github.com/TykTechnologies/tyk) ⭐ 10,625 | 🐛 393 | 🌐 Go | 📅 2026-02-06 - An enterprise-grade, open-source gateway supporting REST, GraphQL, TCP, and gRPC with advanced rate limiting and analytics.
...
* [Envoy Gateway (⭐2.4k)](https://github.com/envoyproxy/gateway) ⭐ 2,489 | 🐛 616 | 🌐 Go | 📅 2026-02-07 - CNCF Envoy-based gateway with Gateway API, mTLS, JWT, and other built-ins.
...
* API clients
  * [Hoppscotch (⭐77k)](https://github.com/hoppscotch/hoppscotch) ⭐ 77,797 | 🐛 631 | 🌐 TypeScript | 📅 2026-02-05 - A lightweight, web-based API development tool offering real-time testing with an intuitive interface.
  * [Bruno (⭐40k)](https://github.com/usebruno/bruno) ⭐ 40,645 | 🐛 1,697 | 🌐 JavaScript | 📅 2026-02-06 - A fast, offline API client designed for git-friendly workflows and seamless testing.
  * [curl (⭐40k)](https://github.com/curl/curl) ⭐ 40,618 | 🐛 26 | 🌐 C | 📅 2026-02-06 - A versatile command-line tool for data transfer across multiple protocols, essential for quick API testing.
  * [Insomnia (⭐37k)](https://github.com/Kong/insomnia) ⭐ 37,907 | 🐛 816 | 🌐 TypeScript | 📅 2026-02-06 - A cross-platform client that streamlines API debugging and testing for both REST and GraphQL services.
  * [HTTPie (⭐37k)](https://github.com/httpie/httpie) ⭐ 37,498 | 🐛 239 | 🌐 Python | 📅 2024-12-17 - An intuitive CLI HTTP client that simplifies crafting API requests and inspecting responses.
  * [posting (⭐11k)](https://github.com/darrenburns/posting) ⭐ 11,295 | 🐛 73 | 🌐 Python | 📅 2025-10-14 - A modern, terminal-based API client designed for efficient and seamless API interactions.
  * [Requestly (⭐6.1k)](https://github.com/requestly/requestly) ⭐ 6,213 | 🐛 317 | 🌐 TypeScript | 📅 2026-02-07 - Lightweight Git-Friendly API Client Built for Modern Developers.
  ...
  * [SoapUI (⭐1.6k)](https://github.com/SmartBear/soapui) ⭐ 1,669 | 🐛 141 | 🌐 Java | 📅 2026-02-06 - A comprehensive open-source solution for testing both SOAP and REST web services with extensive automation features.
...
* Testing tools and frameworks
  * [Grafana k6 (⭐29k)](https://github.com/grafana/k6) ⭐ 29,863 | 🐛 771 | 🌐 Go | 📅 2026-02-07 - Open-source, JS-scriptable load-testing tool for CI/CD.
  ...
  * [ghz (⭐3.2k)](https://github.com/bojand/ghz) ⭐ 3,281 | 🐛 96 | 🌐 Go | 📅 2026-02-01 - A simple gRPC benchmarking and load testing tool with support for various load schedules, concurrency control, and detailed performance metrics.
  * [Schemathesis (⭐3k)](https://github.com/schemathesis/schemathesis) ⭐ 3,022 | 🐛 40 | 🌐 Python | 📅 2026-02-05 - A Python library for property-based testing of API schemas, ensuring reliability through robust edge-case detection.
...
* Mocking tools
  * [Mockoon (⭐8k)](https://github.com/mockoon/mockoon) ⭐ 8,054 | 🐛 63 | 🌐 TypeScript | 📅 2026-02-06 - A user-friendly tool for designing and running mock REST APIs with real-time simulation and easy setup.
  * [WireMock (⭐7.1k)](https://github.com/tomakehurst/wiremock) ⭐ 7,120 | 🐛 463 | 🌐 Java | 📅 2026-02-06 - A robust and flexible API mocking tool delivering reliable, real-time simulation for comprehensive testing.
  ...
  * [Prism (⭐4.8k)](https://github.com/stoplightio/prism) ⭐ 4,836 | 🐛 130 | 🌐 TypeScript | 📅 2026-02-03 - An open-source HTTP mock server that replicates API behavior for early testing and validation.
  ...
  * [Microcks (⭐1.7k)](https://github.com/microcks/microcks) ⭐ 1,800 | 🐛 57 | 🌐 Java | 📅 2026-02-05 - A Kubernetes-native tool for API mocking and testing that supports AsyncAPI, OpenAPI, and Postman Collections.
...
* MQ clients
  ...
  * [MQTT Explorer (⭐3.7k)](https://github.com/thomasnordquist/MQTT-Explorer) ⭐ 3,770 | 🐛 341 | 🌐 TypeScript | 📅 2026-02-02 - A detailed MQTT client delivering structured topic visualization and intuitive debugging.
...
* [Drools (⭐6.2k)](https://github.com/apache/incubator-kie-drools) ⭐ 6,217 | 🐛 89 | 🌐 Java | 📅 2026-02-06 - Open-source engine that supports advanced Decision Model and Notation (DMN) with Eclipse IDE integration for efficient rule development.
* [Easy Rules (⭐5.2k)](https://github.com/j-easy/easy-rules) ⭐ 5,227 | 🐛 88 | 🌐 Java | 📅 2024-05-29 - Lightweight Java-based rules engine designed for straightforward rule processing and rapid decision automation.
...
* [Debezium (⭐12k)](https://github.com/debezium/debezium) ⭐ 12,379 | 🐛 109 | 🌐 Java | 📅 2026-02-05 - Open-source distributed platform for change data capture that turns your existing databases into event streams for real-time data integration.
...
* [Airbyte (⭐20k)](https://github.com/airbytehq/airbyte) ⭐ 20,650 | 🐛 2,332 | 🌐 Python | 📅 2026-02-07 - Flexible, open-source data integration platform that builds ELT pipelines to move data from diverse sources to modern destinations.
* [Pentaho Data Integration (⭐8.3k)](https://github.com/pentaho/pentaho-kettle) ⭐ 8,303 | 🐛 55 | 🌐 Java | 📅 2026-02-07 - Intuitive, visual ETL tool that simplifies data ingestion, blending, and cleansing across multiple sources without heavy coding.
* [Apache NiFi (⭐5.9k)](https://github.com/apache/nifi) ⭐ 5,948 | 🐛 24 | 🌐 Java | 📅 2026-02-06 - Automated data integration tool with a visual interface that seamlessly extracts, transforms, and delivers data across systems.
...
* [Estuary Flow (⭐872)](https://github.com/estuary/flow) ⭐ 874 | 🐛 131 | 🌐 C++ | 📅 2026-02-07 - Versatile, scalable platform that provides both real-time and batch data integration for ETL and ELT pipelines.
...
* [Apache Camel (⭐6.1k)](https://github.com/apache/camel) ⭐ 6,110 | 🐛 10 | 🌐 Java | 📅 2026-02-06 - Robust integration framework leveraging Enterprise Integration Patterns to seamlessly connect diverse systems and APIs.
* [Ballerina (⭐3.8k)](https://github.com/ballerina-platform/ballerina-lang) ⭐ 3,806 | 🐛 1,546 | 🌐 Ballerina | 📅 2026-02-06 - Innovative programming language designed for effortless creation and integration of network services and APIs.
* [Spring Integration (⭐1.6k)](https://github.com/spring-projects/spring-integration) ⭐ 1,617 | 🐛 94 | 🌐 Java | 📅 2026-02-06 - Extension of the Spring ecosystem that provides out-of-the-box integration capabilities using proven Enterprise Integration Patterns.
...
* [Apache Kafka (⭐31k)](https://github.com/apache/kafka) ⭐ 31,849 | 🐛 270 | 🌐 Java | 📅 2026-02-07 - Distributed, high-throughput system designed for real-time data streaming and fault-tolerant processing.
* [NSQ (⭐25k)](https://github.com/nsqio/nsq) ⭐ 25,924 | 🐛 73 | 🌐 Go | 📅 2025-07-13 - Realtime distributed messaging platform designed to operate at scale, handling billions of messages per day with decentralized topology.
* [Apache RocketMQ (⭐22k)](https://github.com/apache/rocketmq) ⭐ 22,328 | 🐛 276 | 🌐 Java | 📅 2026-02-06 - High-performance distributed messaging platform engineered for low latency and high throughput.
* [NATS (⭐19k)](https://github.com/nats-io/gnatsd) ⭐ 19,104 | 🐛 483 | 🌐 Go | 📅 2026-02-06 - Lightweight, high-performance messaging system ideal for microservices and cloud-native architectures.
* [EMQX (⭐15k)](https://github.com/emqx/emqx) ⭐ 15,905 | 🐛 228 | 🌐 Erlang | 📅 2026-02-07 - High-performance MQTT broker built for IoT and industrial applications, ensuring scalable message delivery.
* [Apache Pulsar (⭐15k)](https://github.com/apache/pulsar) ⭐ 15,080 | 🐛 1,638 | 🌐 Java | 📅 2026-02-06 - Versatile pub/sub and streaming platform offering scalable, low-latency messaging for modern applications.
* [RabbitMQ (⭐13k)](https://github.com/rabbitmq/rabbitmq-server) ⭐ 13,443 | 🐛 263 | 🌐 JavaScript | 📅 2026-02-07 - Popular open-source broker implementing AMQP, known for reliability, clustering, and ease-of-use.
* [Redpanda (⭐11k)](https://github.com/vectorizedio/redpanda) ⭐ 11,688 | 🐛 662 | 🌐 C++ | 📅 2026-02-07 - Kafka-compatible streaming platform that eliminates Zookeeper, delivering high performance and low latency.
* [Eclipse Mosquitto (⭐10k)](https://github.com/eclipse/mosquitto) ⭐ 10,593 | 🐛 817 | 🌐 C | 📅 2026-02-06 - Lightweight MQTT broker optimized for low-power devices with robust encryption and authentication.
* [Centrifugo (⭐9.9k)](https://github.com/centrifugal/centrifugo) ⭐ 9,920 | 🐛 28 | 🌐 Go | 📅 2026-02-01 - Scalable real-time messaging server that minimizes delay in delivering events to online users.
...
* [LavinMQ (⭐853)](https://github.com/cloudamqp/lavinmq) ⭐ 857 | 🐛 98 | 🌐 Crystal | 📅 2026-02-06 - High-performance message queue server implementing AMQP 0-9-1 and MQTT protocols, built with Crystal for exceptional throughput and minimal resource usage.
...
* [n8n (⭐172k)](https://github.com/n8n-io/n8n) ⭐ 173,396 | 🐛 1,309 | 🌐 TypeScript | 📅 2026-02-06 - Open-source workflow automation tool with 400+ connectors, giving you full control over your data and integrations.
...
* [Apache Airflow (⭐44k)](https://github.com/apache/airflow) ⭐ 44,168 | 🐛 1,746 | 🌐 Python | 📅 2026-02-07 - Platform for programmatically creating, scheduling, and monitoring workflows, ideal for managing complex data pipelines.
* [Prefect (⭐21k)](https://github.com/PrefectHQ/prefect) ⭐ 21,567 | 🐛 1,076 | 🌐 Python | 📅 2026-02-07 - Modern, developer-friendly orchestration tool optimized for data pipelines and complex workflows.
* [Temporal (⭐18k)](https://github.com/temporalio/temporal) ⭐ 18,185 | 🐛 647 | 🌐 Go | 📅 2026-02-07 - Open-source workflow-as-code platform designed for building reliable, scalable, and fault-tolerant applications.
* [Argo Workflows (⭐16k)](https://github.com/argoproj/argo-workflows) ⭐ 16,437 | 🐛 1,372 | 🌐 Go | 📅 2026-02-06 - Container-native workflow engine designed for orchestrating parallel jobs in Kubernetes-based, cloud-native environments.
...
* [Cadence (⭐9.1k)](https://github.com/uber/cadence) ⭐ 9,165 | 🐛 198 | 🌐 Go | 📅 2026-02-07 - Fault-tolerant, stateful platform that reliably orchestrates long-running workflows and complex applications.
* [Flowable (⭐9k)](https://github.com/flowable/flowable-engine) ⭐ 9,067 | 🐛 385 | 🌐 Java | 📅 2026-02-04 - Compact, efficient set of open-source engines for automating and scaling enterprise workflows.
* [Elsa Core (⭐7.5k)](https://github.com/elsa-workflows/elsa-core) ⭐ 7,607 | 🐛 788 | 🌐 C# | 📅 2026-02-06 - .NET Core library that integrates seamlessly into any application to execute and manage workflows.
...
* [Azkaban (⭐4.5k)](https://github.com/azkaban/azkaban) ⭐ 4,515 | 🐛 802 | 🌐 Java | 📅 2024-07-03 - Distributed scheduler that simplifies managing job dependencies in large-scale data processing environments.
...
* [OpenAPI (ex.Swagger) (⭐30k)](https://github.com/OAI/OpenAPI-Specification) ⭐ 30,896 | 🐛 112 | 🌐 Markdown | 📅 2026-02-05 - A language-agnostic specification for creating RESTful APIs that enables both humans and machines to understand the capabilities of a service without the need for source code or documentation.
...
* [AsyncAPI (⭐5k)](https://github.com/asyncapi/spec) ⭐ 5,080 | 🐛 39 | 🌐 JavaScript | 📅 2026-01-31 - An essential tool for developing Event-Driven Architectures (EDA) and enables engineers to build a better tooling ecosystem.
...
* [API-Security-Checklist (⭐23k)](https://github.com/shieldfy/API-Security-Checklist) ⭐ 23,163 | 🐛 2 | 📅 2026-02-03 - Best practices about REST API security.
...
* [YAML (⭐451)](https://github.com/yaml/yaml-spec) ⭐ 452 | 🐛 73 | 🌐 HTML | 📅 2024-08-20 - A human-friendly and easy-to-read data serialization format that is widely used for configuration files and data exchange. It supports rich data types and is compatible with most programming languages.
...
* [JSON Schema (⭐4.8k)](https://github.com/json-schema-org/json-schema-spec) ⭐ 4,831 | 🐛 66 | 🌐 JavaScript | 📅 2026-01-25 - A powerful tool for validating the structure of JSON data. JSON Schema enables developers to ensure that JSON data conforms to a specific structure, making it easier to process and manipulate.
