...
* [WSO2 API Manager (⭐965)](https://github.com/wso2/product-apim) ⭐ 968 | 🐛 660 | 🌐 Java | 📅 2026-02-20 - A fully open-source API platform offering robust governance, flexible deployment, and community-driven innovation.
* [Gravitee.io API Management (⭐379)](https://github.com/gravitee-io/gravitee-api-management) ⭐ 382 | 🐛 66 | 🌐 Java | 📅 2026-02-19 - A lightweight, open-source platform offering flexible API governance, robust security, and straightforward configuration.
...
* [OpenAPI Generator (⭐25k)](https://github.com/OpenAPITools/openapi-generator) ⭐ 25,841 | 🐛 5,597 | 🌐 Java | 📅 2026-02-19 - Automate the creation of API client libraries, server stubs, documentation and config files with this powerful OpenAPI Spec tool.
...
* [Spectral (⭐3k)](https://github.com/stoplightio/spectral) ⭐ 3,009 | 🐛 236 | 🌐 TypeScript | 📅 2026-02-19 - Detect and fix errors in your JSON/YAML files using this linter tool that supports OpenAPI 3.0 & 2.0 and AsyncAPI.
...
* [OpenAPI Diff (⭐1k)](https://github.com/OpenAPITools/openapi-diff) ⭐ 1,052 | 🐛 81 | 🌐 Java | 📅 2026-02-18 - Compare OpenAPI specs with version control and visualize the differences in HTML or Markdown format.
...
* [OpenAPI Style Validator (⭐232)](https://github.com/OpenAPITools/openapi-style-validator) ⭐ 234 | 🐛 31 | 🌐 Java | 📅 2025-11-17 - Ensure that your OpenAPI specs meet your organization's standards with this flexible and customizable style validator.
...
* [Swagger UI (⭐28k)](https://github.com/swagger-api/swagger-ui) ⭐ 28,631 | 🐛 1,369 | 🌐 JavaScript | 📅 2026-02-19 - Offers an interactive, in-browser tool for visualizing and testing APIs directly from OpenAPI specifications.
* [Redoc (⭐25k)](https://github.com/Redocly/redoc) ⭐ 25,504 | 🐛 429 | 🌐 TypeScript | 📅 2026-02-07 - Delivers clean, modern documentation with advanced theming, multi-language support, and seamless integration.
* [Stoplight Elements (⭐2.3k)](https://github.com/stoplightio/elements) ⭐ 2,358 | 🐛 260 | 🌐 TypeScript | 📅 2026-02-17 - Provides modular, attractive UI components for building comprehensive API reference and tutorial documentation.
...
* [Zudoku (⭐456)](https://github.com/zuplo/zudoku) ⭐ 458 | 🐛 51 | 🌐 TypeScript | 📅 2026-02-19 - A customizable framework built on OpenAPI, focused on delivering exceptional developer experiences through quality documentation.
...
* [Traefik API Gateway (⭐61k)](https://github.com/traefik/traefik) ⭐ 61,815 | 🐛 770 | 🌐 Go | 📅 2026-02-19 - Combines Traefik Proxy, a fully declarative application proxy with enterprise-grade access control, distributed security, and premium integrations.
* [Kong API Gateway (⭐42k)](https://github.com/Kong/kong) ⭐ 42,799 | 🐛 131 | 🌐 Lua | 📅 2026-01-19 - A scalable, cloud-native gateway that simplifies API management through extensive plugin support and seamless microservices integration.
* [Apache APISIX (⭐16k)](https://github.com/apache/apisix) ⭐ 16,225 | 🐛 347 | 🌐 Lua | 📅 2026-02-17 - A high-performance, dynamic gateway featuring real-time traffic management and powerful plugin integrations.
* [Tyk API Gateway (⭐10k)](https://github.com/TykTechnologies/tyk) ⭐ 10,636 | 🐛 393 | 🌐 Go | 📅 2026-02-19 - An enterprise-grade, open-source gateway supporting REST, GraphQL, TCP, and gRPC with advanced rate limiting and analytics.
...
* [Spring Cloud Gateway (⭐4.8k)](https://github.com/spring-cloud/spring-cloud-gateway) ⭐ 4,823 | 🐛 502 | 🌐 Java | 📅 2026-02-19 - Leverages the Spring ecosystem to deliver robust routing, filtering, and security for microservices.
...
* [Envoy Gateway (⭐2.5k)](https://github.com/envoyproxy/gateway) ⭐ 2,522 | 🐛 629 | 🌐 Go | 📅 2026-02-19 - CNCF Envoy-based gateway with Gateway API, mTLS, JWT, and other built-ins.
...
* [Gloo Edge (⭐150)](https://github.com/solo-io/gloo) ⭐ 150 | 🐛 2,390 | 🌐 Go | 📅 2026-02-19 - An Envoy Proxy–based gateway offering advanced traffic control, enhanced security, and observability for microservices ecosystems.
...
* API clients
  * [Hoppscotch (⭐77k)](https://github.com/hoppscotch/hoppscotch) ⭐ 77,884 | 🐛 656 | 🌐 TypeScript | 📅 2026-02-19 - A lightweight, web-based API development tool offering real-time testing with an intuitive interface.
  * [Bruno (⭐40k)](https://github.com/usebruno/bruno) ⭐ 40,990 | 🐛 1,728 | 🌐 JavaScript | 📅 2026-02-19 - A fast, offline API client designed for git-friendly workflows and seamless testing.
  * [curl (⭐40k)](https://github.com/curl/curl) ⭐ 40,877 | 🐛 43 | 🌐 C | 📅 2026-02-19 - A versatile command-line tool for data transfer across multiple protocols, essential for quick API testing.
  * [Insomnia (⭐37k)](https://github.com/Kong/insomnia) ⭐ 37,949 | 🐛 809 | 🌐 TypeScript | 📅 2026-02-17 - A cross-platform client that streamlines API debugging and testing for both REST and GraphQL services.
  * [HTTPie (⭐37k)](https://github.com/httpie/httpie) ⭐ 37,574 | 🐛 244 | 🌐 Python | 📅 2024-12-17 - An intuitive CLI HTTP client that simplifies crafting API requests and inspecting responses.
  * [Yaak (⭐17k)](https://github.com/mountain-loop/yaak) ⭐ 17,877 | 🐛 15 | 🌐 TypeScript | 📅 2026-02-19 - A fast, privacy-first desktop API client for REST, GraphQL, WebSocket, Server-Sent Events, and gRPC with offline-first design, built with Tauri and React.
  * [grpcurl (⭐12k)](https://github.com/fullstorydev/grpcurl) ⭐ 12,451 | 🐛 120 | 🌐 Go | 📅 2026-01-27 - A command-line tool for interacting with gRPC servers, enabling inspection and invocation of RPC methods with support for server reflection and protocol buffer files.
  * [posting (⭐11k)](https://github.com/darrenburns/posting) ⭐ 11,372 | 🐛 76 | 🌐 Python | 📅 2025-10-14 - A modern, terminal-based API client designed for efficient and seamless API interactions.
  * [xh (⭐7.5k)](https://github.com/ducaale/xh) ⭐ 7,592 | 🐛 40 | 🌐 Rust | 📅 2026-02-01 - A fast, friendly CLI HTTP client that reimplements HTTPie's design with improved performance, HTTP/2 support, and built-in curl translation.
  * [Requestly (⭐6.2k)](https://github.com/requestly/requestly) ⭐ 6,342 | 🐛 330 | 🌐 TypeScript | 📅 2026-02-20 - Lightweight Git-Friendly API Client Built for Modern Developers.
  * [gRPC UI (⭐5.8k)](https://github.com/fullstorydev/grpcui) ⭐ 5,826 | 🐛 76 | 🌐 Go | 📅 2026-02-09 - An interactive web-based tool for gRPC APIs, providing a browser-based interface for testing and exploring gRPC services with dynamic form generation.
...
* Testing tools and frameworks
  * [Grafana k6 (⭐29k)](https://github.com/grafana/k6) ⭐ 29,931 | 🐛 794 | 🌐 Go | 📅 2026-02-19 - Open-source, JS-scriptable load-testing tool for CI/CD.
  * [Hurl (⭐18k)](https://github.com/Orange-OpenSource/hurl) ⭐ 18,521 | 🐛 193 | 🌐 Rust | 📅 2026-02-20 - A command-line tool for running HTTP requests with plain text syntax, excellent for both API testing and CI/CD integration with support for chaining, capturing values, and comprehensive assertions.
  * [Keploy (⭐15k)](https://github.com/keploy/keploy) ⭐ 15,711 | 🐛 543 | 🌐 Go | 📅 2026-02-20 - A developer-centric API and integration testing tool that auto-generates tests and data-mocks from real traffic using eBPF, supporting any language without code changes.
  * [Apache JMeter (⭐9.2k)](https://github.com/apache/jmeter) ⭐ 9,231 | 🐛 935 | 🌐 Java | 📅 2026-02-12 - A feature-rich tool for load testing and performance analysis across diverse web applications and services.
  ...
  * [REST Assured (⭐7.1k)](https://github.com/rest-assured/rest-assured) ⭐ 7,110 | 🐛 586 | 🌐 Java | 📅 2026-02-04 - A Java DSL that simplifies REST API testing with intuitive syntax and seamless integration into CI pipelines.
  * [Gatling (⭐6.8k)](https://github.com/gatling/gatling) ⭐ 6,865 | 🐛 25 | 🌐 Scala | 📅 2026-02-17 - A powerful load testing framework with a developer-friendly DSL that delivers detailed performance metrics.
  ...
  * [Taurus (⭐2k)](https://github.com/Blazemeter/taurus) ⭐ 2,098 | 🐛 34 | 🌐 Python | 📅 2026-02-19 - An open-source automation framework that simplifies continuous testing with intuitive configuration and integration support.
...
* Mocking tools
  * [Mockoon (⭐8k)](https://github.com/mockoon/mockoon) ⭐ 8,079 | 🐛 67 | 🌐 TypeScript | 📅 2026-02-14 - A user-friendly tool for designing and running mock REST APIs with real-time simulation and easy setup.
  * [WireMock (⭐7.1k)](https://github.com/tomakehurst/wiremock) ⭐ 7,139 | 🐛 467 | 🌐 Java | 📅 2026-02-19 - A robust and flexible API mocking tool delivering reliable, real-time simulation for comprehensive testing.
  ...
  * [Prism (⭐4.8k)](https://github.com/stoplightio/prism) ⭐ 4,853 | 🐛 131 | 🌐 TypeScript | 📅 2026-02-18 - An open-source HTTP mock server that replicates API behavior for early testing and validation.
  ...
  * [Microcks (⭐1.8k)](https://github.com/microcks/microcks) ⭐ 1,810 | 🐛 63 | 🌐 Java | 📅 2026-02-19 - A Kubernetes-native tool for API mocking and testing that supports AsyncAPI, OpenAPI, and Postman Collections.
  ...
  * [Mockbin (⭐134)](https://github.com/zuplo/mockbin) ⭐ 135 | 🐛 7 | 🌐 TypeScript | 📅 2025-10-30 - A simple endpoint generator for testing HTTP requests with real-time logging and feedback.
...
* MQ clients
  ...
  * [Service Bus Explorer (⭐2.1k)](https://github.com/paolosalvatori/ServiceBusExplorer) ⭐ 2,166 | 🐛 64 | 🌐 C# | 📅 2026-02-04 - An advanced GUI for Azure Service Bus that enables in-depth testing and seamless management of topics, queues, and subscriptions.
...
* [Drools (⭐6.2k)](https://github.com/apache/incubator-kie-drools) ⭐ 6,220 | 🐛 86 | 🌐 Java | 📅 2026-02-19 - Open-source engine that supports advanced Decision Model and Notation (DMN) with Eclipse IDE integration for efficient rule development.
...
* [ZEN Engine (⭐1.5k)](https://github.com/gorules/zen) ⭐ 1,587 | 🐛 41 | 🌐 Rust | 📅 2026-02-19 - A cross-platform, open-source Business Rules Engine written in Rust that executes JSON Decision Models through interconnected graphs of decision tables, functions, and expressions.
* [OpenL Tablets (⭐189)](https://github.com/openl-tablets/openl-tablets) ⭐ 189 | 🐛 45 | 🌐 Java | 📅 2026-02-20 - Flexible open-source decision management system that simplifies defining and executing business rules and decision tables.
...
* [Debezium (⭐12k)](https://github.com/debezium/debezium) ⭐ 12,419 | 🐛 109 | 🌐 Java | 📅 2026-02-19 - Open-source distributed platform for change data capture that turns your existing databases into event streams for real-time data integration.
...
* [Airbyte (⭐20k)](https://github.com/airbytehq/airbyte) ⭐ 20,740 | 🐛 2,328 | 🌐 Python | 📅 2026-02-20 - Flexible, open-source data integration platform that builds ELT pipelines to move data from diverse sources to modern destinations.
* [Pentaho Data Integration (⭐8.3k)](https://github.com/pentaho/pentaho-kettle) ⭐ 8,310 | 🐛 56 | 🌐 Java | 📅 2026-02-19 - Intuitive, visual ETL tool that simplifies data ingestion, blending, and cleansing across multiple sources without heavy coding.
* [Apache NiFi (⭐5.9k)](https://github.com/apache/nifi) ⭐ 5,976 | 🐛 29 | 🌐 Java | 📅 2026-02-19 - Automated data integration tool with a visual interface that seamlessly extracts, transforms, and delivers data across systems.
...
* [Estuary Flow (⭐876)](https://github.com/estuary/flow) ⭐ 879 | 🐛 141 | 🌐 C++ | 📅 2026-02-19 - Versatile, scalable platform that provides both real-time and batch data integration for ETL and ELT pipelines.
...
* [NServiceBus (⭐2.1k)](https://github.com/Particular/NServiceBus) ⭐ 2,162 | 🐛 295 | 🌐 C# | 📅 2026-02-18 - Developer-friendly, .NET-based service bus that simplifies messaging and orchestrates service integration efficiently.
...
* [Apache Camel (⭐6.1k)](https://github.com/apache/camel) ⭐ 6,132 | 🐛 14 | 🌐 Java | 📅 2026-02-20 - Robust integration framework leveraging Enterprise Integration Patterns to seamlessly connect diverse systems and APIs.
* [Ballerina (⭐3.8k)](https://github.com/ballerina-platform/ballerina-lang) ⭐ 3,808 | 🐛 1,554 | 🌐 Ballerina | 📅 2026-02-20 - Innovative programming language designed for effortless creation and integration of network services and APIs.
* [Spring Integration (⭐1.6k)](https://github.com/spring-projects/spring-integration) ⭐ 1,620 | 🐛 96 | 🌐 Java | 📅 2026-02-19 - Extension of the Spring ecosystem that provides out-of-the-box integration capabilities using proven Enterprise Integration Patterns.
* [Frank!Framework (⭐154)](https://github.com/frankframework/frankframework) ⭐ 152 | 🐛 237 | 🌐 Java | 📅 2026-02-20 - Low-code Java messaging framework that simplifies system connectivity and data integration through configurable XML setups.
...
* [Apache Kafka (⭐31k)](https://github.com/apache/kafka) ⭐ 32,011 | 🐛 288 | 🌐 Java | 📅 2026-02-19 - Distributed, high-throughput system designed for real-time data streaming and fault-tolerant processing.
* [NSQ (⭐25k)](https://github.com/nsqio/nsq) ⭐ 25,924 | 🐛 74 | 🌐 Go | 📅 2025-07-13 - Realtime distributed messaging platform designed to operate at scale, handling billions of messages per day with decentralized topology.
* [Apache RocketMQ (⭐22k)](https://github.com/apache/rocketmq) ⭐ 22,336 | 🐛 278 | 🌐 Java | 📅 2026-02-13 - High-performance distributed messaging platform engineered for low latency and high throughput.
* [NATS (⭐19k)](https://github.com/nats-io/gnatsd) ⭐ 19,177 | 🐛 484 | 🌐 Go | 📅 2026-02-19 - Lightweight, high-performance messaging system ideal for microservices and cloud-native architectures.
* [EMQX (⭐15k)](https://github.com/emqx/emqx) ⭐ 15,938 | 🐛 230 | 🌐 Erlang | 📅 2026-02-19 - High-performance MQTT broker built for IoT and industrial applications, ensuring scalable message delivery.
* [Apache Pulsar (⭐15k)](https://github.com/apache/pulsar) ⭐ 15,101 | 🐛 1,647 | 🌐 Java | 📅 2026-02-20 - Versatile pub/sub and streaming platform offering scalable, low-latency messaging for modern applications.
* [RabbitMQ (⭐13k)](https://github.com/rabbitmq/rabbitmq-server) ⭐ 13,471 | 🐛 270 | 🌐 JavaScript | 📅 2026-02-19 - Popular open-source broker implementing AMQP, known for reliability, clustering, and ease-of-use.
* [Redpanda (⭐11k)](https://github.com/vectorizedio/redpanda) ⭐ 11,749 | 🐛 680 | 🌐 C++ | 📅 2026-02-20 - Kafka-compatible streaming platform that eliminates Zookeeper, delivering high performance and low latency.
* [Eclipse Mosquitto (⭐10k)](https://github.com/eclipse/mosquitto) ⭐ 10,639 | 🐛 713 | 🌐 C | 📅 2026-02-18 - Lightweight MQTT broker optimized for low-power devices with robust encryption and authentication.
...
* [BlazingMQ (⭐3.1k)](https://github.com/bloomberg/blazingmq) ⭐ 3,136 | 🐛 90 | 🌐 C++ | 📅 2026-02-19 - Distributed message queuing system focused on efficiency and reliability for modern workflow needs.
...
* [Apache ActiveMQ (⭐2.4k)](https://github.com/apache/activemq) ⭐ 2,418 | 🐛 66 | 🌐 Java | 📅 2026-02-19 - Open-source broker that implements JMS, enabling seamless conversion between synchronous and asynchronous messaging.
* [RMQ (⭐1.6k)](https://github.com/wellle/rmq) ⭐ 1,615 | 🐛 3 | 🌐 Go | 📅 2024-12-13 - Redis-backed message queue written in Go, providing flexible queue management, batch consumers, and efficient delivery patterns.
...
* [LavinMQ (⭐859)](https://github.com/cloudamqp/lavinmq) ⭐ 862 | 🐛 117 | 🌐 Crystal | 📅 2026-02-19 - High-performance message queue server implementing AMQP 0-9-1 and MQTT protocols, built with Crystal for exceptional throughput and minimal resource usage.
* [Apache Qpid (⭐67)](https://github.com/apache/qpid-broker-j) ⭐ 68 | 🐛 9 | 🌐 Java | 📅 2026-02-19 - AMQP-compliant messaging tool with multi-language support for enterprise-grade message delivery.
...
* [OpenRPA (⭐2.8k)](https://github.com/open-rpa/openrpa) ⭐ 2,869 | 🐛 2 | 🌐 C# | 📅 2025-06-03 - Enterprise-grade, open-source robotic process automation suite.
...
* [n8n (⭐174k)](https://github.com/n8n-io/n8n) ⭐ 175,407 | 🐛 1,401 | 🌐 TypeScript | 📅 2026-02-20 - Open-source workflow automation tool with 400+ connectors, giving you full control over your data and integrations.
...
* [Apache Airflow (⭐44k)](https://github.com/apache/airflow) ⭐ 44,326 | 🐛 1,756 | 🌐 Python | 📅 2026-02-20 - Platform for programmatically creating, scheduling, and monitoring workflows, ideal for managing complex data pipelines.
* [Prefect (⭐21k)](https://github.com/PrefectHQ/prefect) ⭐ 21,640 | 🐛 1,062 | 🌐 Python | 📅 2026-02-20 - Modern, developer-friendly orchestration tool optimized for data pipelines and complex workflows.
* [Temporal (⭐18k)](https://github.com/temporalio/temporal) ⭐ 18,411 | 🐛 642 | 🌐 Go | 📅 2026-02-20 - Open-source workflow-as-code platform designed for building reliable, scalable, and fault-tolerant applications.
* [Argo Workflows (⭐16k)](https://github.com/argoproj/argo-workflows) ⭐ 16,461 | 🐛 1,371 | 🌐 Go | 📅 2026-02-20 - Container-native workflow engine designed for orchestrating parallel jobs in Kubernetes-based, cloud-native environments.
...
* [Activiti (⭐10k)](https://github.com/Activiti/Activiti) ⭐ 10,516 | 🐛 666 | 🌐 Java | 📅 2026-02-19 - Lightweight, Java-centric BPMN engine that efficiently executes business workflows with a focus on simplicity.
* [Cadence (⭐9.1k)](https://github.com/uber/cadence) ⭐ 9,189 | 🐛 194 | 🌐 Go | 📅 2026-02-19 - Fault-tolerant, stateful platform that reliably orchestrates long-running workflows and complex applications.
* [Flowable (⭐9k)](https://github.com/flowable/flowable-engine) ⭐ 9,088 | 🐛 386 | 🌐 Java | 📅 2026-02-17 - Compact, efficient set of open-source engines for automating and scaling enterprise workflows.
* [Elsa Core (⭐7.6k)](https://github.com/elsa-workflows/elsa-core) ⭐ 7,629 | 🐛 794 | 🌐 C# | 📅 2026-02-19 - .NET Core library that integrates seamlessly into any application to execute and manage workflows.
...
* [Bonita (⭐172)](https://github.com/bonitasoft/bonita-engine) ⭐ 172 | 🐛 0 | 🌐 Java | 📅 2026-02-19 - Open-source BPMN engine with a designer interface to build and automate complex business processes.
...
* [OpenAPI (ex.Swagger) (⭐30k)](https://github.com/OAI/OpenAPI-Specification) ⭐ 30,935 | 🐛 112 | 🌐 Markdown | 📅 2026-02-19 - A language-agnostic specification for creating RESTful APIs that enables both humans and machines to understand the capabilities of a service without the need for source code or documentation.
...
* [JSON:API (⭐7.6k)](https://github.com/json-api/json-api) ⭐ 7,679 | 🐛 149 | 🌐 CSS | 📅 2025-03-13 - A standardized specification for building APIs that simplifies the representation of resources, relationships, and metadata, making it easier for software engineers to create efficient APIs.
* [CloudEvents (⭐5.6k)](https://github.com/cloudevents/spec) ⭐ 5,687 | 🐛 18 | 🌐 Python | 📅 2026-02-12 -  A specification for describing event data in common formats to provide interoperability across services, platforms and systems.
* [AsyncAPI (⭐5k)](https://github.com/asyncapi/spec) ⭐ 5,095 | 🐛 41 | 🌐 JavaScript | 📅 2026-02-14 - An essential tool for developing Event-Driven Architectures (EDA) and enables engineers to build a better tooling ecosystem.
...
* [API-Security-Checklist (⭐23k)](https://github.com/shieldfy/API-Security-Checklist) ⭐ 23,172 | 🐛 2 | 📅 2026-02-10 - Best practices about REST API security.
...
* [JSON](https://datatracker.ietf.org/doc/html/rfc8259) - A lightweight and easy-to-read data format that is widely used for data exchange. It supports a wide range of data types and is compatible with many programming languages.
  * [NDJSON (⭐803)](https://github.com/ndjson/ndjson-spec) ⭐ 804 | 🐛 16 | 📅 2022-10-20 - A standard for delimiting JSON objects in stream protocols. It allows for efficient processing of large JSON datasets and is widely used in big data processing.
...
* [YAML (⭐453)](https://github.com/yaml/yaml-spec) ⭐ 452 | 🐛 74 | 🌐 HTML | 📅 2024-08-20 - A human-friendly and easy-to-read data serialization format that is widely used for configuration files and data exchange. It supports rich data types and is compatible with most programming languages.
...
* [OpenMessaging (⭐290)](https://github.com/openmessaging/specification) ⭐ 289 | 🐛 5 | 📅 2023-07-26 - A cloud native, vendor-neutral open specification for distributed messaging.
...
* [JSON Schema (⭐4.8k)](https://github.com/json-schema-org/json-schema-spec) ⭐ 4,858 | 🐛 63 | 🌐 JavaScript | 📅 2026-02-10 - A powerful tool for validating the structure of JSON data. JSON Schema enables developers to ensure that JSON data conforms to a specific structure, making it easier to process and manipulate.
...
Your contributions are always welcome! Please take a look at the [contribution guidelines](https://github.com/stn1slv/awesome-integration/blob/main/CONTRIBUTING.md) ⭐ 514 | 🐛 2 | 🌐 Markdown | 📅 2026-02-14 first.
