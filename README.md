...
* [WSO2 API Manager (⭐965)](https://github.com/wso2/product-apim) ⭐ 965 | 🐛 655 | 🌐 Java | 📅 2026-02-03 - A fully open-source API platform offering robust governance, flexible deployment, and community-driven innovation.
* [Gravitee.io API Management (⭐379)](https://github.com/gravitee-io/gravitee-api-management) ⭐ 379 | 🐛 59 | 🌐 Java | 📅 2026-02-10 - A lightweight, open-source platform offering flexible API governance, robust security, and straightforward configuration.
...
* [OpenAPI Generator (⭐25k)](https://github.com/OpenAPITools/openapi-generator) ⭐ 25,790 | 🐛 5,581 | 🌐 Java | 📅 2026-02-10 - Automate the creation of API client libraries, server stubs, documentation and config files with this powerful OpenAPI Spec tool.
* [Swagger Editor (⭐9.4k)](https://github.com/swagger-api/swagger-editor) ⭐ 9,415 | 🐛 34 | 🌐 JavaScript | 📅 2026-02-10 - Create, describe, and document your API with ease using this open source editor built specifically for OpenAPI-based APIs.
...
* [Spectral (⭐3k)](https://github.com/stoplightio/spectral) ⭐ 3,002 | 🐛 236 | 🌐 TypeScript | 📅 2026-02-10 - Detect and fix errors in your JSON/YAML files using this linter tool that supports OpenAPI 3.0 & 2.0 and AsyncAPI.
...
* [OpenAPI Diff (⭐1k)](https://github.com/OpenAPITools/openapi-diff) ⭐ 1,046 | 🐛 85 | 🌐 Java | 📅 2026-01-26 - Compare OpenAPI specs with version control and visualize the differences in HTML or Markdown format.
...
* [Swagger UI (⭐28k)](https://github.com/swagger-api/swagger-ui) ⭐ 28,615 | 🐛 1,369 | 🌐 JavaScript | 📅 2026-02-10 - Offers an interactive, in-browser tool for visualizing and testing APIs directly from OpenAPI specifications.
* [Redoc (⭐25k)](https://github.com/Redocly/redoc) ⭐ 25,487 | 🐛 428 | 🌐 TypeScript | 📅 2026-02-07 - Delivers clean, modern documentation with advanced theming, multi-language support, and seamless integration.
* [Stoplight Elements (⭐2.3k)](https://github.com/stoplightio/elements) ⭐ 2,354 | 🐛 258 | 🌐 TypeScript | 📅 2026-02-10 - Provides modular, attractive UI components for building comprehensive API reference and tutorial documentation.
...
* [Zudoku (⭐449)](https://github.com/zuplo/zudoku) ⭐ 450 | 🐛 80 | 🌐 TypeScript | 📅 2026-02-10 - A customizable framework built on OpenAPI, focused on delivering exceptional developer experiences through quality documentation.
...
* [Traefik API Gateway (⭐61k)](https://github.com/traefik/traefik) ⭐ 61,565 | 🐛 745 | 🌐 Go | 📅 2026-02-10 - Combines Traefik Proxy, a fully declarative application proxy with enterprise-grade access control, distributed security, and premium integrations.
* [Kong API Gateway (⭐42k)](https://github.com/Kong/kong) ⭐ 42,729 | 🐛 131 | 🌐 Lua | 📅 2026-01-19 - A scalable, cloud-native gateway that simplifies API management through extensive plugin support and seamless microservices integration.
* [Apache APISIX (⭐16k)](https://github.com/apache/apisix) ⭐ 16,198 | 🐛 352 | 🌐 Lua | 📅 2026-02-11 - A high-performance, dynamic gateway featuring real-time traffic management and powerful plugin integrations.
* [Tyk API Gateway (⭐10k)](https://github.com/TykTechnologies/tyk) ⭐ 10,627 | 🐛 393 | 🌐 Go | 📅 2026-02-11 - An enterprise-grade, open-source gateway supporting REST, GraphQL, TCP, and gRPC with advanced rate limiting and analytics.
* [Apache ShenYu (⭐8.7k)](https://github.com/apache/shenyu) ⭐ 8,767 | 🐛 155 | 🌐 Java | 📅 2026-02-10 - A Java-native gateway excelling in protocol conversion, service proxying, and comprehensive API governance.
* [Ocelot (⭐8.6k)](https://github.com/ThreeMammals/Ocelot) ⭐ 8,689 | 🐛 62 | 🌐 C# | 📅 2026-02-10 - A .NET-based gateway offering intuitive routing and easy integration for lightweight API management.
* [Spring Cloud Gateway (⭐4.8k)](https://github.com/spring-cloud/spring-cloud-gateway) ⭐ 4,821 | 🐛 499 | 🌐 Java | 📅 2026-02-09 - Leverages the Spring ecosystem to deliver robust routing, filtering, and security for microservices.
* [KrakenD API Gateway (⭐2.5k)](https://github.com/devopsfaith/krakend-ce) ⭐ 2,536 | 🐛 31 | 🌐 Go | 📅 2026-02-10 - An ultra-high performance gateway with efficient middleware configuration, robust security, and seamless scaling.
* [Envoy Gateway (⭐2.4k)](https://github.com/envoyproxy/gateway) ⭐ 2,500 | 🐛 635 | 🌐 Go | 📅 2026-02-11 - CNCF Envoy-based gateway with Gateway API, mTLS, JWT, and other built-ins.
...
* [Gloo Edge (⭐149)](https://github.com/solo-io/gloo) ⭐ 149 | 🐛 2,389 | 🌐 Go | 📅 2026-02-10 - An Envoy Proxy–based gateway offering advanced traffic control, enhanced security, and observability for microservices ecosystems.
...
* API clients
  * [Hoppscotch (⭐77k)](https://github.com/hoppscotch/hoppscotch) ⭐ 77,839 | 🐛 635 | 🌐 TypeScript | 📅 2026-02-09 - A lightweight, web-based API development tool offering real-time testing with an intuitive interface.
  * [Bruno (⭐40k)](https://github.com/usebruno/bruno) ⭐ 40,797 | 🐛 1,708 | 🌐 JavaScript | 📅 2026-02-10 - A fast, offline API client designed for git-friendly workflows and seamless testing.
  * [curl (⭐40k)](https://github.com/curl/curl) ⭐ 40,656 | 🐛 29 | 🌐 C | 📅 2026-02-11 - A versatile command-line tool for data transfer across multiple protocols, essential for quick API testing.
  * [Insomnia (⭐37k)](https://github.com/Kong/insomnia) ⭐ 37,932 | 🐛 817 | 🌐 TypeScript | 📅 2026-02-11 - A cross-platform client that streamlines API debugging and testing for both REST and GraphQL services.
  * [HTTPie (⭐37k)](https://github.com/httpie/httpie) ⭐ 37,527 | 🐛 241 | 🌐 Python | 📅 2024-12-17 - An intuitive CLI HTTP client that simplifies crafting API requests and inspecting responses.
  * [posting (⭐11k)](https://github.com/darrenburns/posting) ⭐ 11,315 | 🐛 73 | 🌐 Python | 📅 2025-10-14 - A modern, terminal-based API client designed for efficient and seamless API interactions.
  * [Requestly (⭐6.2k)](https://github.com/requestly/requestly) ⭐ 6,236 | 🐛 315 | 🌐 TypeScript | 📅 2026-02-11 - Lightweight Git-Friendly API Client Built for Modern Developers.
  * [gRPC UI (⭐5.8k)](https://github.com/fullstorydev/grpcui) ⭐ 5,819 | 🐛 76 | 🌐 Go | 📅 2026-02-09 - An interactive web-based tool for gRPC APIs, providing a browser-based interface for testing and exploring gRPC services with dynamic form generation.
...
* Testing tools and frameworks
  * [Grafana k6 (⭐29k)](https://github.com/grafana/k6) ⭐ 29,888 | 🐛 781 | 🌐 Go | 📅 2026-02-10 - Open-source, JS-scriptable load-testing tool for CI/CD.
  * [Apache JMeter (⭐9.2k)](https://github.com/apache/jmeter) ⭐ 9,222 | 🐛 940 | 🌐 Java | 📅 2026-01-12 - A feature-rich tool for load testing and performance analysis across diverse web applications and services.
  ...
  * [Gatling (⭐6.8k)](https://github.com/gatling/gatling) ⭐ 6,861 | 🐛 25 | 🌐 Scala | 📅 2026-02-08 - A powerful load testing framework with a developer-friendly DSL that delivers detailed performance metrics.
  * [ghz (⭐3.2k)](https://github.com/bojand/ghz) ⭐ 3,283 | 🐛 96 | 🌐 Go | 📅 2026-02-01 - A simple gRPC benchmarking and load testing tool with support for various load schedules, concurrency control, and detailed performance metrics.
  * [Schemathesis (⭐3k)](https://github.com/schemathesis/schemathesis) ⭐ 3,037 | 🐛 39 | 🌐 Python | 📅 2026-02-10 - A Python library for property-based testing of API schemas, ensuring reliability through robust edge-case detection.
  ...
  * [Taurus (⭐2k)](https://github.com/Blazemeter/taurus) ⭐ 2,097 | 🐛 37 | 🌐 Python | 📅 2026-02-10 - An open-source automation framework that simplifies continuous testing with intuitive configuration and integration support.
...
* Mocking tools
  * [Mockoon (⭐8k)](https://github.com/mockoon/mockoon) ⭐ 8,059 | 🐛 64 | 🌐 TypeScript | 📅 2026-02-06 - A user-friendly tool for designing and running mock REST APIs with real-time simulation and easy setup.
  * [WireMock (⭐7.1k)](https://github.com/tomakehurst/wiremock) ⭐ 7,124 | 🐛 464 | 🌐 Java | 📅 2026-02-11 - A robust and flexible API mocking tool delivering reliable, real-time simulation for comprehensive testing.
  ...
  * [Prism (⭐4.8k)](https://github.com/stoplightio/prism) ⭐ 4,839 | 🐛 130 | 🌐 TypeScript | 📅 2026-02-03 - An open-source HTTP mock server that replicates API behavior for early testing and validation.
  ...
  * [Microcks (⭐1.8k)](https://github.com/microcks/microcks) ⭐ 1,806 | 🐛 58 | 🌐 Java | 📅 2026-02-10 - A Kubernetes-native tool for API mocking and testing that supports AsyncAPI, OpenAPI, and Postman Collections.
  * [Imposter (⭐401)](https://github.com/outofcoffee/imposter) ⭐ 401 | 🐛 56 | 🌐 Shell | 📅 2026-01-22 - A flexible mock server supporting REST, OpenAPI, SOAP, and more to simulate diverse API behaviors.
...
* MQ clients
  * [kcat (⭐5.7k)](https://github.com/edenhill/kcat) ⭐ 5,723 | 🐛 162 | 🌐 C | 📅 2024-07-09 - A lightweight command-line tool for Apache Kafka, providing efficient message production and consumption.
  * [MQTT Explorer (⭐3.7k)](https://github.com/thomasnordquist/MQTT-Explorer) ⭐ 3,775 | 🐛 341 | 🌐 TypeScript | 📅 2026-02-07 - A detailed MQTT client delivering structured topic visualization and intuitive debugging.
...
* [Drools (⭐6.2k)](https://github.com/apache/incubator-kie-drools) ⭐ 6,223 | 🐛 87 | 🌐 Java | 📅 2026-02-09 - Open-source engine that supports advanced Decision Model and Notation (DMN) with Eclipse IDE integration for efficient rule development.
...
* [ZEN Engine (⭐1.5k)](https://github.com/gorules/zen) ⭐ 1,572 | 🐛 39 | 🌐 Rust | 📅 2026-02-09 - A cross-platform, open-source Business Rules Engine written in Rust that executes JSON Decision Models through interconnected graphs of decision tables, functions, and expressions.
* [OpenL Tablets (⭐189)](https://github.com/openl-tablets/openl-tablets) ⭐ 189 | 🐛 38 | 🌐 Java | 📅 2026-02-10 - Flexible open-source decision management system that simplifies defining and executing business rules and decision tables.
...
* [Debezium (⭐12k)](https://github.com/debezium/debezium) ⭐ 12,388 | 🐛 111 | 🌐 Java | 📅 2026-02-10 - Open-source distributed platform for change data capture that turns your existing databases into event streams for real-time data integration.
...
* [Airbyte (⭐20k)](https://github.com/airbytehq/airbyte) ⭐ 20,681 | 🐛 2,336 | 🌐 Python | 📅 2026-02-11 - Flexible, open-source data integration platform that builds ELT pipelines to move data from diverse sources to modern destinations.
* [Pentaho Data Integration (⭐8.3k)](https://github.com/pentaho/pentaho-kettle) ⭐ 8,309 | 🐛 54 | 🌐 Java | 📅 2026-02-11 - Intuitive, visual ETL tool that simplifies data ingestion, blending, and cleansing across multiple sources without heavy coding.
* [Apache NiFi (⭐5.9k)](https://github.com/apache/nifi) ⭐ 5,954 | 🐛 23 | 🌐 Java | 📅 2026-02-10 - Automated data integration tool with a visual interface that seamlessly extracts, transforms, and delivers data across systems.
...
* [Estuary Flow (⭐876)](https://github.com/estuary/flow) ⭐ 876 | 🐛 132 | 🌐 C++ | 📅 2026-02-11 - Versatile, scalable platform that provides both real-time and batch data integration for ETL and ELT pipelines.
...
* [JSLT (⭐686)](https://github.com/schibsted/jslt) ⭐ 686 | 🐛 114 | 🌐 Java | 📅 2025-06-29 - Powerful JSON query and transformation language inspired by jq and XPath, designed for rapid and flexible data manipulation.
...
* [NServiceBus (⭐2.1k)](https://github.com/Particular/NServiceBus) ⭐ 2,161 | 🐛 295 | 🌐 C# | 📅 2026-02-10 - Developer-friendly, .NET-based service bus that simplifies messaging and orchestrates service integration efficiently.
...
* [Apache Camel (⭐6.1k)](https://github.com/apache/camel) ⭐ 6,121 | 🐛 13 | 🌐 Java | 📅 2026-02-10 - Robust integration framework leveraging Enterprise Integration Patterns to seamlessly connect diverse systems and APIs.
* [Ballerina (⭐3.8k)](https://github.com/ballerina-platform/ballerina-lang) ⭐ 3,808 | 🐛 1,553 | 🌐 Ballerina | 📅 2026-02-10 - Innovative programming language designed for effortless creation and integration of network services and APIs.
* [Spring Integration (⭐1.6k)](https://github.com/spring-projects/spring-integration) ⭐ 1,618 | 🐛 94 | 🌐 Java | 📅 2026-02-10 - Extension of the Spring ecosystem that provides out-of-the-box integration capabilities using proven Enterprise Integration Patterns.
* [Frank!Framework (⭐154)](https://github.com/frankframework/frankframework) ⭐ 154 | 🐛 232 | 🌐 Java | 📅 2026-02-10 - Low-code Java messaging framework that simplifies system connectivity and data integration through configurable XML setups.
...
* [Apache Kafka (⭐31k)](https://github.com/apache/kafka) ⭐ 31,865 | 🐛 275 | 🌐 Java | 📅 2026-02-11 - Distributed, high-throughput system designed for real-time data streaming and fault-tolerant processing.
...
* [Apache RocketMQ (⭐22k)](https://github.com/apache/rocketmq) ⭐ 22,333 | 🐛 285 | 🌐 Java | 📅 2026-02-11 - High-performance distributed messaging platform engineered for low latency and high throughput.
* [NATS (⭐19k)](https://github.com/nats-io/gnatsd) ⭐ 19,127 | 🐛 482 | 🌐 Go | 📅 2026-02-10 - Lightweight, high-performance messaging system ideal for microservices and cloud-native architectures.
* [EMQX (⭐15k)](https://github.com/emqx/emqx) ⭐ 15,922 | 🐛 225 | 🌐 Erlang | 📅 2026-02-10 - High-performance MQTT broker built for IoT and industrial applications, ensuring scalable message delivery.
* [Apache Pulsar (⭐15k)](https://github.com/apache/pulsar) ⭐ 15,085 | 🐛 1,639 | 🌐 Java | 📅 2026-02-10 - Versatile pub/sub and streaming platform offering scalable, low-latency messaging for modern applications.
* [RabbitMQ (⭐13k)](https://github.com/rabbitmq/rabbitmq-server) ⭐ 13,450 | 🐛 265 | 🌐 JavaScript | 📅 2026-02-10 - Popular open-source broker implementing AMQP, known for reliability, clustering, and ease-of-use.
* [Redpanda (⭐11k)](https://github.com/vectorizedio/redpanda) ⭐ 11,708 | 🐛 662 | 🌐 C++ | 📅 2026-02-11 - Kafka-compatible streaming platform that eliminates Zookeeper, delivering high performance and low latency.
* [Eclipse Mosquitto (⭐10k)](https://github.com/eclipse/mosquitto) ⭐ 10,608 | 🐛 720 | 🌐 C | 📅 2026-02-10 - Lightweight MQTT broker optimized for low-power devices with robust encryption and authentication.
* [Centrifugo (⭐9.9k)](https://github.com/centrifugal/centrifugo) ⭐ 9,949 | 🐛 28 | 🌐 Go | 📅 2026-02-01 - Scalable real-time messaging server that minimizes delay in delivering events to online users.
* [VerneMQ (⭐3.5k)](https://github.com/vernemq/vernemq) ⭐ 3,525 | 🐛 164 | 🌐 Erlang | 📅 2026-01-08 - High-performance distributed MQTT broker designed for scalable and efficient message delivery in modern environments.
* [BlazingMQ (⭐3.1k)](https://github.com/bloomberg/blazingmq) ⭐ 3,133 | 🐛 87 | 🌐 C++ | 📅 2026-02-10 - Distributed message queuing system focused on efficiency and reliability for modern workflow needs.
* [Apache ActiveMQ (⭐2.4k)](https://github.com/apache/activemq) ⭐ 2,414 | 🐛 68 | 🌐 Java | 📅 2026-02-09 - Open-source broker that implements JMS, enabling seamless conversion between synchronous and asynchronous messaging.
* [Apache Artemis (⭐999)](https://github.com/apache/artemis) ⭐ 999 | 🐛 14 | 🌐 Java | 📅 2026-02-10 - A multi-protocol message broker, supporting various industry standard protocols such as AMQP 1.0, MQTT 3.1.1, MQTT 5, and STOMP.
* [LavinMQ (⭐859)](https://github.com/cloudamqp/lavinmq) ⭐ 859 | 🐛 104 | 🌐 Crystal | 📅 2026-02-10 - High-performance message queue server implementing AMQP 0-9-1 and MQTT protocols, built with Crystal for exceptional throughput and minimal resource usage.
...
* [n8n (⭐173k)](https://github.com/n8n-io/n8n) ⭐ 174,007 | 🐛 1,325 | 🌐 TypeScript | 📅 2026-02-11 - Open-source workflow automation tool with 400+ connectors, giving you full control over your data and integrations.
...
* [Apache Airflow (⭐44k)](https://github.com/apache/airflow) ⭐ 44,223 | 🐛 1,736 | 🌐 Python | 📅 2026-02-10 - Platform for programmatically creating, scheduling, and monitoring workflows, ideal for managing complex data pipelines.
* [Prefect (⭐21k)](https://github.com/PrefectHQ/prefect) ⭐ 21,591 | 🐛 1,064 | 🌐 Python | 📅 2026-02-11 - Modern, developer-friendly orchestration tool optimized for data pipelines and complex workflows.
* [Temporal (⭐18k)](https://github.com/temporalio/temporal) ⭐ 18,253 | 🐛 652 | 🌐 Go | 📅 2026-02-11 - Open-source workflow-as-code platform designed for building reliable, scalable, and fault-tolerant applications.
* [Argo Workflows (⭐16k)](https://github.com/argoproj/argo-workflows) ⭐ 16,448 | 🐛 1,371 | 🌐 Go | 📅 2026-02-11 - Container-native workflow engine designed for orchestrating parallel jobs in Kubernetes-based, cloud-native environments.
...
* [Activiti (⭐10k)](https://github.com/Activiti/Activiti) ⭐ 10,519 | 🐛 672 | 🌐 Java | 📅 2026-02-10 - Lightweight, Java-centric BPMN engine that efficiently executes business workflows with a focus on simplicity.
* [Cadence (⭐9.1k)](https://github.com/uber/cadence) ⭐ 9,173 | 🐛 200 | 🌐 Go | 📅 2026-02-10 - Fault-tolerant, stateful platform that reliably orchestrates long-running workflows and complex applications.
* [Flowable (⭐9k)](https://github.com/flowable/flowable-engine) ⭐ 9,078 | 🐛 385 | 🌐 Java | 📅 2026-02-04 - Compact, efficient set of open-source engines for automating and scaling enterprise workflows.
* [Elsa Core (⭐7.6k)](https://github.com/elsa-workflows/elsa-core) ⭐ 7,615 | 🐛 782 | 🌐 C# | 📅 2026-02-10 - .NET Core library that integrates seamlessly into any application to execute and manage workflows.
* [StackStorm (⭐6.4k)](https://github.com/StackStorm/st2) ⭐ 6,406 | 🐛 595 | 🌐 Python | 📅 2026-02-02 - Robust automation engine that combines sensors, triggers, and workflows to orchestrate complex IT processes.
...
* [OpenAPI (ex.Swagger) (⭐30k)](https://github.com/OAI/OpenAPI-Specification) ⭐ 30,908 | 🐛 111 | 🌐 Markdown | 📅 2026-02-08 - A language-agnostic specification for creating RESTful APIs that enables both humans and machines to understand the capabilities of a service without the need for source code or documentation.
* [GraphQL (⭐14k)](https://github.com/graphql/graphql-spec) ⭐ 14,781 | 🐛 208 | 🌐 JavaScript | 📅 2026-02-05 - A sophisticated query language and runtime for building efficient APIs that empowers engineers to retrieve data from existing systems with ease.
...
* [CloudEvents (⭐5.6k)](https://github.com/cloudevents/spec) ⭐ 5,677 | 🐛 25 | 🌐 Python | 📅 2025-12-04 -  A specification for describing event data in common formats to provide interoperability across services, platforms and systems.
* [AsyncAPI (⭐5k)](https://github.com/asyncapi/spec) ⭐ 5,087 | 🐛 40 | 🌐 JavaScript | 📅 2026-01-31 - An essential tool for developing Event-Driven Architectures (EDA) and enables engineers to build a better tooling ecosystem.
...
* [API-Security-Checklist (⭐23k)](https://github.com/shieldfy/API-Security-Checklist) ⭐ 23,170 | 🐛 1 | 📅 2026-02-10 - Best practices about REST API security.
...
* [JSON Schema (⭐4.8k)](https://github.com/json-schema-org/json-schema-spec) ⭐ 4,840 | 🐛 61 | 🌐 JavaScript | 📅 2026-02-10 - A powerful tool for validating the structure of JSON data. JSON Schema enables developers to ensure that JSON data conforms to a specific structure, making it easier to process and manipulate.
...
Your contributions are always welcome! Please take a look at the [contribution guidelines](https://github.com/stn1slv/awesome-integration/blob/main/CONTRIBUTING.md) ⭐ 514 | 🐛 1 | 🌐 Markdown | 📅 2026-02-11 first.
