...
* [WSO2 API Manager (⭐965)](https://github.com/wso2/product-apim) ⭐ 966 | 🐛 656 | 🌐 Java | 📅 2026-02-16 - A fully open-source API platform offering robust governance, flexible deployment, and community-driven innovation.
* [Gravitee.io API Management (⭐379)](https://github.com/gravitee-io/gravitee-api-management) ⭐ 380 | 🐛 59 | 🌐 Java | 📅 2026-02-16 - A lightweight, open-source platform offering flexible API governance, robust security, and straightforward configuration.
...
* [OpenAPI Generator (⭐25k)](https://github.com/OpenAPITools/openapi-generator) ⭐ 25,825 | 🐛 5,583 | 🌐 Java | 📅 2026-02-16 - Automate the creation of API client libraries, server stubs, documentation and config files with this powerful OpenAPI Spec tool.
* [Swagger Editor (⭐9.4k)](https://github.com/swagger-api/swagger-editor) ⭐ 9,418 | 🐛 30 | 🌐 JavaScript | 📅 2026-02-16 - Create, describe, and document your API with ease using this open source editor built specifically for OpenAPI-based APIs.
...
* [OpenAPI Diff (⭐1k)](https://github.com/OpenAPITools/openapi-diff) ⭐ 1,052 | 🐛 86 | 🌐 Java | 📅 2026-01-26 - Compare OpenAPI specs with version control and visualize the differences in HTML or Markdown format.
...
* [Swagger UI (⭐28k)](https://github.com/swagger-api/swagger-ui) ⭐ 28,624 | 🐛 1,366 | 🌐 JavaScript | 📅 2026-02-16 - Offers an interactive, in-browser tool for visualizing and testing APIs directly from OpenAPI specifications.
* [Redoc (⭐25k)](https://github.com/Redocly/redoc) ⭐ 25,495 | 🐛 428 | 🌐 TypeScript | 📅 2026-02-07 - Delivers clean, modern documentation with advanced theming, multi-language support, and seamless integration.
* [Stoplight Elements (⭐2.3k)](https://github.com/stoplightio/elements) ⭐ 2,357 | 🐛 259 | 🌐 TypeScript | 📅 2026-02-16 - Provides modular, attractive UI components for building comprehensive API reference and tutorial documentation.
...
* [Zudoku (⭐456)](https://github.com/zuplo/zudoku) ⭐ 456 | 🐛 71 | 🌐 TypeScript | 📅 2026-02-16 - A customizable framework built on OpenAPI, focused on delivering exceptional developer experiences through quality documentation.
...
* [Traefik API Gateway (⭐61k)](https://github.com/traefik/traefik) ⭐ 61,673 | 🐛 763 | 🌐 Go | 📅 2026-02-13 - Combines Traefik Proxy, a fully declarative application proxy with enterprise-grade access control, distributed security, and premium integrations.
* [Kong API Gateway (⭐42k)](https://github.com/Kong/kong) ⭐ 42,782 | 🐛 130 | 🌐 Lua | 📅 2026-01-19 - A scalable, cloud-native gateway that simplifies API management through extensive plugin support and seamless microservices integration.
* [Apache APISIX (⭐16k)](https://github.com/apache/apisix) ⭐ 16,217 | 🐛 341 | 🌐 Lua | 📅 2026-02-13 - A high-performance, dynamic gateway featuring real-time traffic management and powerful plugin integrations.
* [Tyk API Gateway (⭐10k)](https://github.com/TykTechnologies/tyk) ⭐ 10,634 | 🐛 389 | 🌐 Go | 📅 2026-02-16 - An enterprise-grade, open-source gateway supporting REST, GraphQL, TCP, and gRPC with advanced rate limiting and analytics.
...
* [Ocelot (⭐8.6k)](https://github.com/ThreeMammals/Ocelot) ⭐ 8,691 | 🐛 62 | 🌐 C# | 📅 2026-02-12 - A .NET-based gateway offering intuitive routing and easy integration for lightweight API management.
* [Spring Cloud Gateway (⭐4.8k)](https://github.com/spring-cloud/spring-cloud-gateway) ⭐ 4,823 | 🐛 504 | 🌐 Java | 📅 2026-02-09 - Leverages the Spring ecosystem to deliver robust routing, filtering, and security for microservices.
* [KrakenD API Gateway (⭐2.5k)](https://github.com/devopsfaith/krakend-ce) ⭐ 2,540 | 🐛 31 | 🌐 Go | 📅 2026-02-10 - An ultra-high performance gateway with efficient middleware configuration, robust security, and seamless scaling.
* [Envoy Gateway (⭐2.5k)](https://github.com/envoyproxy/gateway) ⭐ 2,516 | 🐛 618 | 🌐 Go | 📅 2026-02-16 - CNCF Envoy-based gateway with Gateway API, mTLS, JWT, and other built-ins.
...
* API clients
  * [Hoppscotch (⭐77k)](https://github.com/hoppscotch/hoppscotch) ⭐ 77,866 | 🐛 651 | 🌐 TypeScript | 📅 2026-02-16 - A lightweight, web-based API development tool offering real-time testing with an intuitive interface.
  * [Bruno (⭐40k)](https://github.com/usebruno/bruno) ⭐ 40,905 | 🐛 1,710 | 🌐 JavaScript | 📅 2026-02-16 - A fast, offline API client designed for git-friendly workflows and seamless testing.
  * [curl (⭐40k)](https://github.com/curl/curl) ⭐ 40,719 | 🐛 34 | 🌐 C | 📅 2026-02-16 - A versatile command-line tool for data transfer across multiple protocols, essential for quick API testing.
  * [Insomnia (⭐37k)](https://github.com/Kong/insomnia) ⭐ 37,942 | 🐛 808 | 🌐 TypeScript | 📅 2026-02-16 - A cross-platform client that streamlines API debugging and testing for both REST and GraphQL services.
  * [HTTPie (⭐37k)](https://github.com/httpie/httpie) ⭐ 37,564 | 🐛 241 | 🌐 Python | 📅 2024-12-17 - An intuitive CLI HTTP client that simplifies crafting API requests and inspecting responses.
  * [Yaak (⭐17k)](https://github.com/mountain-loop/yaak) ⭐ 17,855 | 🐛 15 | 🌐 TypeScript | 📅 2026-02-16 - A fast, privacy-first desktop API client for REST, GraphQL, WebSocket, Server-Sent Events, and gRPC with offline-first design, built with Tauri and React.
  * [grpcurl (⭐12k)](https://github.com/fullstorydev/grpcurl) ⭐ 12,447 | 🐛 118 | 🌐 Go | 📅 2026-01-27 - A command-line tool for interacting with gRPC servers, enabling inspection and invocation of RPC methods with support for server reflection and protocol buffer files.
  * [posting (⭐11k)](https://github.com/darrenburns/posting) ⭐ 11,355 | 🐛 76 | 🌐 Python | 📅 2025-10-14 - A modern, terminal-based API client designed for efficient and seamless API interactions.
  * [xh (⭐7.5k)](https://github.com/ducaale/xh) ⭐ 7,583 | 🐛 38 | 🌐 Rust | 📅 2026-02-01 - A fast, friendly CLI HTTP client that reimplements HTTPie's design with improved performance, HTTP/2 support, and built-in curl translation.
  * [Requestly (⭐6.2k)](https://github.com/requestly/requestly) ⭐ 6,259 | 🐛 317 | 🌐 TypeScript | 📅 2026-02-17 - Lightweight Git-Friendly API Client Built for Modern Developers.
  * [gRPC UI (⭐5.8k)](https://github.com/fullstorydev/grpcui) ⭐ 5,825 | 🐛 76 | 🌐 Go | 📅 2026-02-09 - An interactive web-based tool for gRPC APIs, providing a browser-based interface for testing and exploring gRPC services with dynamic form generation.
...
* Testing tools and frameworks
  * [Grafana k6 (⭐29k)](https://github.com/grafana/k6) ⭐ 29,913 | 🐛 789 | 🌐 Go | 📅 2026-02-16 - Open-source, JS-scriptable load-testing tool for CI/CD.
  * [Hurl (⭐18k)](https://github.com/Orange-OpenSource/hurl) ⭐ 18,511 | 🐛 195 | 🌐 Rust | 📅 2026-02-17 - A command-line tool for running HTTP requests with plain text syntax, excellent for both API testing and CI/CD integration with support for chaining, capturing values, and comprehensive assertions.
  * [Keploy (⭐15k)](https://github.com/keploy/keploy) ⭐ 15,676 | 🐛 537 | 🌐 Go | 📅 2026-02-17 - A developer-centric API and integration testing tool that auto-generates tests and data-mocks from real traffic using eBPF, supporting any language without code changes.
  ...
  * [ghz (⭐3.2k)](https://github.com/bojand/ghz) ⭐ 3,286 | 🐛 96 | 🌐 Go | 📅 2026-02-01 - A simple gRPC benchmarking and load testing tool with support for various load schedules, concurrency control, and detailed performance metrics.
  * [Schemathesis (⭐3k)](https://github.com/schemathesis/schemathesis) ⭐ 3,046 | 🐛 43 | 🌐 Python | 📅 2026-02-16 - A Python library for property-based testing of API schemas, ensuring reliability through robust edge-case detection.
  ...
  * [Taurus (⭐2k)](https://github.com/Blazemeter/taurus) ⭐ 2,097 | 🐛 34 | 🌐 Python | 📅 2026-02-16 - An open-source automation framework that simplifies continuous testing with intuitive configuration and integration support.
...
* Mocking tools
  * [Mockoon (⭐8k)](https://github.com/mockoon/mockoon) ⭐ 8,072 | 🐛 67 | 🌐 TypeScript | 📅 2026-02-14 - A user-friendly tool for designing and running mock REST APIs with real-time simulation and easy setup.
  * [WireMock (⭐7.1k)](https://github.com/tomakehurst/wiremock) ⭐ 7,135 | 🐛 465 | 🌐 Java | 📅 2026-02-16 - A robust and flexible API mocking tool delivering reliable, real-time simulation for comprehensive testing.
  ...
  * [Microcks (⭐1.8k)](https://github.com/microcks/microcks) ⭐ 1,809 | 🐛 62 | 🌐 Java | 📅 2026-02-16 - A Kubernetes-native tool for API mocking and testing that supports AsyncAPI, OpenAPI, and Postman Collections.
...
* MQ clients
  ...
  * [MQTT Explorer (⭐3.7k)](https://github.com/thomasnordquist/MQTT-Explorer) ⭐ 3,785 | 🐛 344 | 🌐 TypeScript | 📅 2026-02-14 - A detailed MQTT client delivering structured topic visualization and intuitive debugging.
...
* [OpenL Tablets (⭐189)](https://github.com/openl-tablets/openl-tablets) ⭐ 189 | 🐛 39 | 🌐 Java | 📅 2026-02-16 - Flexible open-source decision management system that simplifies defining and executing business rules and decision tables.
...
* [Debezium (⭐12k)](https://github.com/debezium/debezium) ⭐ 12,406 | 🐛 108 | 🌐 Java | 📅 2026-02-13 - Open-source distributed platform for change data capture that turns your existing databases into event streams for real-time data integration.
* [Maxwell's daemon (⭐4.2k)](https://github.com/zendesk/maxwell) ⭐ 4,233 | 🐛 266 | 🌐 Java | 📅 2026-02-16 - An open-source CDC tool for MySQL that reads database binlogs and streams row-level changes as JSON to systems like Kafka, Kinesis, or other destinations.
...
* [Airbyte (⭐20k)](https://github.com/airbytehq/airbyte) ⭐ 20,727 | 🐛 2,328 | 🌐 Python | 📅 2026-02-17 - Flexible, open-source data integration platform that builds ELT pipelines to move data from diverse sources to modern destinations.
* [Pentaho Data Integration (⭐8.3k)](https://github.com/pentaho/pentaho-kettle) ⭐ 8,309 | 🐛 54 | 🌐 Java | 📅 2026-02-17 - Intuitive, visual ETL tool that simplifies data ingestion, blending, and cleansing across multiple sources without heavy coding.
* [Apache NiFi (⭐5.9k)](https://github.com/apache/nifi) ⭐ 5,970 | 🐛 31 | 🌐 Java | 📅 2026-02-16 - Automated data integration tool with a visual interface that seamlessly extracts, transforms, and delivers data across systems.
...
* [Estuary Flow (⭐876)](https://github.com/estuary/flow) ⭐ 876 | 🐛 136 | 🌐 C++ | 📅 2026-02-16 - Versatile, scalable platform that provides both real-time and batch data integration for ETL and ELT pipelines.
...
* [JSONata (⭐2.5k)](https://github.com/jsonata-js/jsonata) ⭐ 2,515 | 🐛 164 | 🌐 JavaScript | 📅 2025-11-06 - Lightweight query and transformation language for JSON data.
...
* [Apache Camel (⭐6.1k)](https://github.com/apache/camel) ⭐ 6,128 | 🐛 18 | 🌐 Java | 📅 2026-02-16 - Robust integration framework leveraging Enterprise Integration Patterns to seamlessly connect diverse systems and APIs.
...
* [Spring Integration (⭐1.6k)](https://github.com/spring-projects/spring-integration) ⭐ 1,620 | 🐛 97 | 🌐 Java | 📅 2026-02-16 - Extension of the Spring ecosystem that provides out-of-the-box integration capabilities using proven Enterprise Integration Patterns.
* [Frank!Framework (⭐154)](https://github.com/frankframework/frankframework) ⭐ 154 | 🐛 237 | 🌐 Java | 📅 2026-02-16 - Low-code Java messaging framework that simplifies system connectivity and data integration through configurable XML setups.
...
* [Apache Kafka (⭐31k)](https://github.com/apache/kafka) ⭐ 31,917 | 🐛 284 | 🌐 Java | 📅 2026-02-17 - Distributed, high-throughput system designed for real-time data streaming and fault-tolerant processing.
* [NSQ (⭐25k)](https://github.com/nsqio/nsq) ⭐ 25,921 | 🐛 74 | 🌐 Go | 📅 2025-07-13 - Realtime distributed messaging platform designed to operate at scale, handling billions of messages per day with decentralized topology.
* [Apache RocketMQ (⭐22k)](https://github.com/apache/rocketmq) ⭐ 22,334 | 🐛 278 | 🌐 Java | 📅 2026-02-13 - High-performance distributed messaging platform engineered for low latency and high throughput.
* [NATS (⭐19k)](https://github.com/nats-io/gnatsd) ⭐ 19,155 | 🐛 479 | 🌐 Go | 📅 2026-02-16 - Lightweight, high-performance messaging system ideal for microservices and cloud-native architectures.
* [EMQX (⭐15k)](https://github.com/emqx/emqx) ⭐ 15,932 | 🐛 234 | 🌐 Erlang | 📅 2026-02-16 - High-performance MQTT broker built for IoT and industrial applications, ensuring scalable message delivery.
* [Apache Pulsar (⭐15k)](https://github.com/apache/pulsar) ⭐ 15,094 | 🐛 1,643 | 🌐 Java | 📅 2026-02-16 - Versatile pub/sub and streaming platform offering scalable, low-latency messaging for modern applications.
* [RabbitMQ (⭐13k)](https://github.com/rabbitmq/rabbitmq-server) ⭐ 13,460 | 🐛 272 | 🌐 JavaScript | 📅 2026-02-17 - Popular open-source broker implementing AMQP, known for reliability, clustering, and ease-of-use.
* [Redpanda (⭐11k)](https://github.com/vectorizedio/redpanda) ⭐ 11,728 | 🐛 671 | 🌐 C++ | 📅 2026-02-15 - Kafka-compatible streaming platform that eliminates Zookeeper, delivering high performance and low latency.
* [Eclipse Mosquitto (⭐10k)](https://github.com/eclipse/mosquitto) ⭐ 10,629 | 🐛 708 | 🌐 C | 📅 2026-02-17 - Lightweight MQTT broker optimized for low-power devices with robust encryption and authentication.
* [Centrifugo (⭐9.9k)](https://github.com/centrifugal/centrifugo) ⭐ 9,961 | 🐛 24 | 🌐 Go | 📅 2026-02-13 - Scalable real-time messaging server that minimizes delay in delivering events to online users.
...
* [SuperMQ (⭐2.5k)](https://github.com/absmach/supermq) ⭐ 2,564 | 🐛 201 | 🌐 Go | 📅 2026-02-16 - Distributed, event-driven infrastructure for messaging supporting multiple protocols (HTTP, MQTT, WebSocket, CoAP) with strong security and IoT capabilities.
* [Apache ActiveMQ (⭐2.4k)](https://github.com/apache/activemq) ⭐ 2,416 | 🐛 67 | 🌐 Java | 📅 2026-02-16 - Open-source broker that implements JMS, enabling seamless conversion between synchronous and asynchronous messaging.
...
* [Apache Artemis (⭐1k)](https://github.com/apache/artemis) ⭐ 1,001 | 🐛 11 | 🌐 Java | 📅 2026-02-16 - A multi-protocol message broker, supporting various industry standard protocols such as AMQP 1.0, MQTT 3.1.1, MQTT 5, and STOMP.
* [LavinMQ (⭐859)](https://github.com/cloudamqp/lavinmq) ⭐ 861 | 🐛 111 | 🌐 Crystal | 📅 2026-02-16 - High-performance message queue server implementing AMQP 0-9-1 and MQTT protocols, built with Crystal for exceptional throughput and minimal resource usage.
...
* [n8n (⭐174k)](https://github.com/n8n-io/n8n) ⭐ 174,840 | 🐛 1,384 | 🌐 TypeScript | 📅 2026-02-17 - Open-source workflow automation tool with 400+ connectors, giving you full control over your data and integrations.
...
* [Apache Airflow (⭐44k)](https://github.com/apache/airflow) ⭐ 44,288 | 🐛 1,757 | 🌐 Python | 📅 2026-02-17 - Platform for programmatically creating, scheduling, and monitoring workflows, ideal for managing complex data pipelines.
* [Prefect (⭐21k)](https://github.com/PrefectHQ/prefect) ⭐ 21,617 | 🐛 1,062 | 🌐 Python | 📅 2026-02-17 - Modern, developer-friendly orchestration tool optimized for data pipelines and complex workflows.
* [Temporal (⭐18k)](https://github.com/temporalio/temporal) ⭐ 18,359 | 🐛 640 | 🌐 Go | 📅 2026-02-16 - Open-source workflow-as-code platform designed for building reliable, scalable, and fault-tolerant applications.
* [Argo Workflows (⭐16k)](https://github.com/argoproj/argo-workflows) ⭐ 16,453 | 🐛 1,365 | 🌐 Go | 📅 2026-02-16 - Container-native workflow engine designed for orchestrating parallel jobs in Kubernetes-based, cloud-native environments.
...
* [Activiti (⭐10k)](https://github.com/Activiti/Activiti) ⭐ 10,515 | 🐛 669 | 🌐 Java | 📅 2026-02-16 - Lightweight, Java-centric BPMN engine that efficiently executes business workflows with a focus on simplicity.
* [Cadence (⭐9.1k)](https://github.com/uber/cadence) ⭐ 9,178 | 🐛 192 | 🌐 Go | 📅 2026-02-16 - Fault-tolerant, stateful platform that reliably orchestrates long-running workflows and complex applications.
* [Flowable (⭐9k)](https://github.com/flowable/flowable-engine) ⭐ 9,087 | 🐛 386 | 🌐 Java | 📅 2026-02-16 - Compact, efficient set of open-source engines for automating and scaling enterprise workflows.
* [Elsa Core (⭐7.6k)](https://github.com/elsa-workflows/elsa-core) ⭐ 7,624 | 🐛 785 | 🌐 C# | 📅 2026-02-16 - .NET Core library that integrates seamlessly into any application to execute and manage workflows.
...
* [jBPM (⭐1.7k)](https://github.com/kiegroup/jbpm) ⭐ 1,723 | 🐛 45 | 🌐 Java | 📅 2026-02-02 - Comprehensive toolkit for automating business processes and decisions with robust workflow management capabilities.
* [Bonita (⭐172)](https://github.com/bonitasoft/bonita-engine) ⭐ 172 | 🐛 0 | 🌐 Java | 📅 2026-02-16 - Open-source BPMN engine with a designer interface to build and automate complex business processes.
...
* [OpenAPI (ex.Swagger) (⭐30k)](https://github.com/OAI/OpenAPI-Specification) ⭐ 30,921 | 🐛 113 | 🌐 Markdown | 📅 2026-02-16 - A language-agnostic specification for creating RESTful APIs that enables both humans and machines to understand the capabilities of a service without the need for source code or documentation.
* [GraphQL (⭐14k)](https://github.com/graphql/graphql-spec) ⭐ 14,783 | 🐛 209 | 🌐 JavaScript | 📅 2026-02-11 - A sophisticated query language and runtime for building efficient APIs that empowers engineers to retrieve data from existing systems with ease.
...
* [CloudEvents (⭐5.6k)](https://github.com/cloudevents/spec) ⭐ 5,680 | 🐛 19 | 🌐 Python | 📅 2026-02-12 -  A specification for describing event data in common formats to provide interoperability across services, platforms and systems.
* [AsyncAPI (⭐5k)](https://github.com/asyncapi/spec) ⭐ 5,094 | 🐛 39 | 🌐 JavaScript | 📅 2026-02-14 - An essential tool for developing Event-Driven Architectures (EDA) and enables engineers to build a better tooling ecosystem.
...
* [JSON Schema (⭐4.8k)](https://github.com/json-schema-org/json-schema-spec) ⭐ 4,851 | 🐛 62 | 🌐 JavaScript | 📅 2026-02-10 - A powerful tool for validating the structure of JSON data. JSON Schema enables developers to ensure that JSON data conforms to a specific structure, making it easier to process and manipulate.
