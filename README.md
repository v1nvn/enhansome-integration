...
* [Gravitee.io API Management (⭐379)](https://github.com/gravitee-io/gravitee-api-management) ⭐ 380 | 🐛 49 | 🌐 Java | 📅 2026-02-11 - A lightweight, open-source platform offering flexible API governance, robust security, and straightforward configuration.
...
* [OpenAPI Generator (⭐25k)](https://github.com/OpenAPITools/openapi-generator) ⭐ 25,796 | 🐛 5,578 | 🌐 Java | 📅 2026-02-11 - Automate the creation of API client libraries, server stubs, documentation and config files with this powerful OpenAPI Spec tool.
* [Swagger Editor (⭐9.4k)](https://github.com/swagger-api/swagger-editor) ⭐ 9,415 | 🐛 35 | 🌐 JavaScript | 📅 2026-02-11 - Create, describe, and document your API with ease using this open source editor built specifically for OpenAPI-based APIs.
...
* [Spectral (⭐3k)](https://github.com/stoplightio/spectral) ⭐ 3,002 | 🐛 236 | 🌐 TypeScript | 📅 2026-02-11 - Detect and fix errors in your JSON/YAML files using this linter tool that supports OpenAPI 3.0 & 2.0 and AsyncAPI.
* [OpenAPI-GUI (⭐1.4k)](https://github.com/Mermade/openapi-gui) ⭐ 1,479 | 🐛 17 | 🌐 JavaScript | 📅 2024-06-16 - Create and validate OpenAPI specs with ease using this intuitive graphical user interface.
...
* [Swagger UI (⭐28k)](https://github.com/swagger-api/swagger-ui) ⭐ 28,622 | 🐛 1,369 | 🌐 JavaScript | 📅 2026-02-11 - Offers an interactive, in-browser tool for visualizing and testing APIs directly from OpenAPI specifications.
* [Redoc (⭐25k)](https://github.com/Redocly/redoc) ⭐ 25,489 | 🐛 428 | 🌐 TypeScript | 📅 2026-02-07 - Delivers clean, modern documentation with advanced theming, multi-language support, and seamless integration.
* [Stoplight Elements (⭐2.3k)](https://github.com/stoplightio/elements) ⭐ 2,354 | 🐛 259 | 🌐 TypeScript | 📅 2026-02-10 - Provides modular, attractive UI components for building comprehensive API reference and tutorial documentation.
* [RapiDoc (⭐1.8k)](https://github.com/rapi-doc/RapiDoc) ⭐ 1,880 | 🐛 130 | 🌐 JavaScript | 📅 2026-02-11 - Produces highly customizable, interactive API documentation with responsive design and rich configuration options.
...
* [Zudoku (⭐449)](https://github.com/zuplo/zudoku) ⭐ 453 | 🐛 79 | 🌐 TypeScript | 📅 2026-02-12 - A customizable framework built on OpenAPI, focused on delivering exceptional developer experiences through quality documentation.
...
* [Traefik API Gateway (⭐61k)](https://github.com/traefik/traefik) ⭐ 61,594 | 🐛 751 | 🌐 Go | 📅 2026-02-11 - Combines Traefik Proxy, a fully declarative application proxy with enterprise-grade access control, distributed security, and premium integrations.
* [Kong API Gateway (⭐42k)](https://github.com/Kong/kong) ⭐ 42,742 | 🐛 130 | 🌐 Lua | 📅 2026-01-19 - A scalable, cloud-native gateway that simplifies API management through extensive plugin support and seamless microservices integration.
* [Apache APISIX (⭐16k)](https://github.com/apache/apisix) ⭐ 16,203 | 🐛 347 | 🌐 Lua | 📅 2026-02-12 - A high-performance, dynamic gateway featuring real-time traffic management and powerful plugin integrations.
* [Tyk API Gateway (⭐10k)](https://github.com/TykTechnologies/tyk) ⭐ 10,628 | 🐛 392 | 🌐 Go | 📅 2026-02-11 - An enterprise-grade, open-source gateway supporting REST, GraphQL, TCP, and gRPC with advanced rate limiting and analytics.
...
* [Spring Cloud Gateway (⭐4.8k)](https://github.com/spring-cloud/spring-cloud-gateway) ⭐ 4,821 | 🐛 500 | 🌐 Java | 📅 2026-02-09 - Leverages the Spring ecosystem to deliver robust routing, filtering, and security for microservices.
...
* [Envoy Gateway (⭐2.4k)](https://github.com/envoyproxy/gateway) ⭐ 2,501 | 🐛 625 | 🌐 Go | 📅 2026-02-12 - CNCF Envoy-based gateway with Gateway API, mTLS, JWT, and other built-ins.
...
* [Gloo Edge (⭐149)](https://github.com/solo-io/gloo) ⭐ 150 | 🐛 2,389 | 🌐 Go | 📅 2026-02-10 - An Envoy Proxy–based gateway offering advanced traffic control, enhanced security, and observability for microservices ecosystems.
...
* API clients
  * [Hoppscotch (⭐77k)](https://github.com/hoppscotch/hoppscotch) ⭐ 77,846 | 🐛 643 | 🌐 TypeScript | 📅 2026-02-09 - A lightweight, web-based API development tool offering real-time testing with an intuitive interface.
  * [Bruno (⭐40k)](https://github.com/usebruno/bruno) ⭐ 40,822 | 🐛 1,710 | 🌐 JavaScript | 📅 2026-02-11 - A fast, offline API client designed for git-friendly workflows and seamless testing.
  * [curl (⭐40k)](https://github.com/curl/curl) ⭐ 40,667 | 🐛 27 | 🌐 C | 📅 2026-02-11 - A versatile command-line tool for data transfer across multiple protocols, essential for quick API testing.
  * [Insomnia (⭐37k)](https://github.com/Kong/insomnia) ⭐ 37,934 | 🐛 817 | 🌐 TypeScript | 📅 2026-02-12 - A cross-platform client that streamlines API debugging and testing for both REST and GraphQL services.
  * [HTTPie (⭐37k)](https://github.com/httpie/httpie) ⭐ 37,536 | 🐛 241 | 🌐 Python | 📅 2024-12-17 - An intuitive CLI HTTP client that simplifies crafting API requests and inspecting responses.
  * [posting (⭐11k)](https://github.com/darrenburns/posting) ⭐ 11,320 | 🐛 73 | 🌐 Python | 📅 2025-10-14 - A modern, terminal-based API client designed for efficient and seamless API interactions.
  * [Requestly (⭐6.2k)](https://github.com/requestly/requestly) ⭐ 6,240 | 🐛 317 | 🌐 TypeScript | 📅 2026-02-11 - Lightweight Git-Friendly API Client Built for Modern Developers.
...
* Testing tools and frameworks
  * [Grafana k6 (⭐29k)](https://github.com/grafana/k6) ⭐ 29,895 | 🐛 781 | 🌐 Go | 📅 2026-02-11 - Open-source, JS-scriptable load-testing tool for CI/CD.
  * [Apache JMeter (⭐9.2k)](https://github.com/apache/jmeter) ⭐ 9,224 | 🐛 940 | 🌐 Java | 📅 2026-01-12 - A feature-rich tool for load testing and performance analysis across diverse web applications and services.
  * [Karate (⭐8.7k)](https://github.com/karatelabs/karate) ⭐ 8,781 | 🐛 68 | 🌐 Java | 📅 2026-02-05 - A unified testing framework that merges API automation, mocking, and performance testing with simple, expressive syntax.
  * [REST Assured (⭐7.1k)](https://github.com/rest-assured/rest-assured) ⭐ 7,110 | 🐛 585 | 🌐 Java | 📅 2026-02-04 - A Java DSL that simplifies REST API testing with intuitive syntax and seamless integration into CI pipelines.
  * [Gatling (⭐6.8k)](https://github.com/gatling/gatling) ⭐ 6,862 | 🐛 25 | 🌐 Scala | 📅 2026-02-08 - A powerful load testing framework with a developer-friendly DSL that delivers detailed performance metrics.
  ...
  * [Schemathesis (⭐3k)](https://github.com/schemathesis/schemathesis) ⭐ 3,041 | 🐛 40 | 🌐 Python | 📅 2026-02-10 - A Python library for property-based testing of API schemas, ensuring reliability through robust edge-case detection.
...
* Mocking tools
  * [Mockoon (⭐8k)](https://github.com/mockoon/mockoon) ⭐ 8,062 | 🐛 63 | 🌐 TypeScript | 📅 2026-02-11 - A user-friendly tool for designing and running mock REST APIs with real-time simulation and easy setup.
  * [WireMock (⭐7.1k)](https://github.com/tomakehurst/wiremock) ⭐ 7,126 | 🐛 462 | 🌐 Java | 📅 2026-02-11 - A robust and flexible API mocking tool delivering reliable, real-time simulation for comprehensive testing.
  * [MockServer (⭐4.8k)](https://github.com/mock-server/mockserver) ⭐ 4,857 | 🐛 317 | 🌐 Java | 📅 2025-12-19 - A powerful solution for mocking any HTTP/HTTPS-based service, streamlining integration testing.
  * [Prism (⭐4.8k)](https://github.com/stoplightio/prism) ⭐ 4,842 | 🐛 130 | 🌐 TypeScript | 📅 2026-02-03 - An open-source HTTP mock server that replicates API behavior for early testing and validation.
  * [Hoverfly (⭐2.4k)](https://github.com/SpectoLabs/hoverfly) ⭐ 2,464 | 🐛 34 | 🌐 Go | 📅 2025-12-19 - A lightweight API simulation tool that enables rapid HTTP(S) service virtualization for efficient testing.
  ...
  * [Microcks (⭐1.8k)](https://github.com/microcks/microcks) ⭐ 1,806 | 🐛 61 | 🌐 Java | 📅 2026-02-10 - A Kubernetes-native tool for API mocking and testing that supports AsyncAPI, OpenAPI, and Postman Collections.
  * [Imposter (⭐401)](https://github.com/outofcoffee/imposter) ⭐ 402 | 🐛 56 | 🌐 Shell | 📅 2026-01-22 - A flexible mock server supporting REST, OpenAPI, SOAP, and more to simulate diverse API behaviors.
...
* MQ clients
  ...
  * [MQTT Explorer (⭐3.7k)](https://github.com/thomasnordquist/MQTT-Explorer) ⭐ 3,776 | 🐛 343 | 🌐 TypeScript | 📅 2026-02-11 - A detailed MQTT client delivering structured topic visualization and intuitive debugging.
...
* [ZEN Engine (⭐1.5k)](https://github.com/gorules/zen) ⭐ 1,579 | 🐛 38 | 🌐 Rust | 📅 2026-02-11 - A cross-platform, open-source Business Rules Engine written in Rust that executes JSON Decision Models through interconnected graphs of decision tables, functions, and expressions.
* [OpenL Tablets (⭐189)](https://github.com/openl-tablets/openl-tablets) ⭐ 189 | 🐛 38 | 🌐 Java | 📅 2026-02-11 - Flexible open-source decision management system that simplifies defining and executing business rules and decision tables.
...
* [Debezium (⭐12k)](https://github.com/debezium/debezium) ⭐ 12,391 | 🐛 108 | 🌐 Java | 📅 2026-02-12 - Open-source distributed platform for change data capture that turns your existing databases into event streams for real-time data integration.
...
* [Airbyte (⭐20k)](https://github.com/airbytehq/airbyte) ⭐ 20,696 | 🐛 2,348 | 🌐 Python | 📅 2026-02-12 - Flexible, open-source data integration platform that builds ELT pipelines to move data from diverse sources to modern destinations.
* [Pentaho Data Integration (⭐8.3k)](https://github.com/pentaho/pentaho-kettle) ⭐ 8,310 | 🐛 54 | 🌐 Java | 📅 2026-02-12 - Intuitive, visual ETL tool that simplifies data ingestion, blending, and cleansing across multiple sources without heavy coding.
* [Apache NiFi (⭐5.9k)](https://github.com/apache/nifi) ⭐ 5,955 | 🐛 25 | 🌐 Java | 📅 2026-02-11 - Automated data integration tool with a visual interface that seamlessly extracts, transforms, and delivers data across systems.
...
* [Estuary Flow (⭐876)](https://github.com/estuary/flow) ⭐ 876 | 🐛 131 | 🌐 C++ | 📅 2026-02-11 - Versatile, scalable platform that provides both real-time and batch data integration for ETL and ELT pipelines.
...
* [Apache Camel (⭐6.1k)](https://github.com/apache/camel) ⭐ 6,122 | 🐛 13 | 🌐 Java | 📅 2026-02-11 - Robust integration framework leveraging Enterprise Integration Patterns to seamlessly connect diverse systems and APIs.
* [Ballerina (⭐3.8k)](https://github.com/ballerina-platform/ballerina-lang) ⭐ 3,808 | 🐛 1,552 | 🌐 Ballerina | 📅 2026-02-12 - Innovative programming language designed for effortless creation and integration of network services and APIs.
* [Spring Integration (⭐1.6k)](https://github.com/spring-projects/spring-integration) ⭐ 1,618 | 🐛 94 | 🌐 Java | 📅 2026-02-11 - Extension of the Spring ecosystem that provides out-of-the-box integration capabilities using proven Enterprise Integration Patterns.
* [Frank!Framework (⭐154)](https://github.com/frankframework/frankframework) ⭐ 154 | 🐛 232 | 🌐 Java | 📅 2026-02-11 - Low-code Java messaging framework that simplifies system connectivity and data integration through configurable XML setups.
...
* [Apache Kafka (⭐31k)](https://github.com/apache/kafka) ⭐ 31,872 | 🐛 277 | 🌐 Java | 📅 2026-02-12 - Distributed, high-throughput system designed for real-time data streaming and fault-tolerant processing.
...
* [Apache RocketMQ (⭐22k)](https://github.com/apache/rocketmq) ⭐ 22,334 | 🐛 283 | 🌐 Java | 📅 2026-02-12 - High-performance distributed messaging platform engineered for low latency and high throughput.
* [NATS (⭐19k)](https://github.com/nats-io/gnatsd) ⭐ 19,131 | 🐛 481 | 🌐 Go | 📅 2026-02-11 - Lightweight, high-performance messaging system ideal for microservices and cloud-native architectures.
* [EMQX (⭐15k)](https://github.com/emqx/emqx) ⭐ 15,922 | 🐛 228 | 🌐 Erlang | 📅 2026-02-12 - High-performance MQTT broker built for IoT and industrial applications, ensuring scalable message delivery.
* [Apache Pulsar (⭐15k)](https://github.com/apache/pulsar) ⭐ 15,086 | 🐛 1,638 | 🌐 Java | 📅 2026-02-12 - Versatile pub/sub and streaming platform offering scalable, low-latency messaging for modern applications.
* [RabbitMQ (⭐13k)](https://github.com/rabbitmq/rabbitmq-server) ⭐ 13,453 | 🐛 264 | 🌐 JavaScript | 📅 2026-02-11 - Popular open-source broker implementing AMQP, known for reliability, clustering, and ease-of-use.
* [Redpanda (⭐11k)](https://github.com/vectorizedio/redpanda) ⭐ 11,713 | 🐛 664 | 🌐 C++ | 📅 2026-02-12 - Kafka-compatible streaming platform that eliminates Zookeeper, delivering high performance and low latency.
* [Eclipse Mosquitto (⭐10k)](https://github.com/eclipse/mosquitto) ⭐ 10,611 | 🐛 717 | 🌐 C | 📅 2026-02-11 - Lightweight MQTT broker optimized for low-power devices with robust encryption and authentication.
* [Centrifugo (⭐9.9k)](https://github.com/centrifugal/centrifugo) ⭐ 9,951 | 🐛 27 | 🌐 Go | 📅 2026-02-11 - Scalable real-time messaging server that minimizes delay in delivering events to online users.
* [VerneMQ (⭐3.5k)](https://github.com/vernemq/vernemq) ⭐ 3,526 | 🐛 163 | 🌐 Erlang | 📅 2026-01-08 - High-performance distributed MQTT broker designed for scalable and efficient message delivery in modern environments.
* [BlazingMQ (⭐3.1k)](https://github.com/bloomberg/blazingmq) ⭐ 3,134 | 🐛 88 | 🌐 C++ | 📅 2026-02-11 - Distributed message queuing system focused on efficiency and reliability for modern workflow needs.
* [Apache ActiveMQ (⭐2.4k)](https://github.com/apache/activemq) ⭐ 2,415 | 🐛 67 | 🌐 Java | 📅 2026-02-11 - Open-source broker that implements JMS, enabling seamless conversion between synchronous and asynchronous messaging.
* [Apache Artemis (⭐999)](https://github.com/apache/artemis) ⭐ 999 | 🐛 12 | 🌐 Java | 📅 2026-02-12 - A multi-protocol message broker, supporting various industry standard protocols such as AMQP 1.0, MQTT 3.1.1, MQTT 5, and STOMP.
* [LavinMQ (⭐859)](https://github.com/cloudamqp/lavinmq) ⭐ 859 | 🐛 102 | 🌐 Crystal | 📅 2026-02-11 - High-performance message queue server implementing AMQP 0-9-1 and MQTT protocols, built with Crystal for exceptional throughput and minimal resource usage.
...
* [n8n (⭐173k)](https://github.com/n8n-io/n8n) ⭐ 174,151 | 🐛 1,350 | 🌐 TypeScript | 📅 2026-02-12 - Open-source workflow automation tool with 400+ connectors, giving you full control over your data and integrations.
...
* [Apache Airflow (⭐44k)](https://github.com/apache/airflow) ⭐ 44,238 | 🐛 1,725 | 🌐 Python | 📅 2026-02-12 - Platform for programmatically creating, scheduling, and monitoring workflows, ideal for managing complex data pipelines.
* [Prefect (⭐21k)](https://github.com/PrefectHQ/prefect) ⭐ 21,600 | 🐛 1,059 | 🌐 Python | 📅 2026-02-12 - Modern, developer-friendly orchestration tool optimized for data pipelines and complex workflows.
* [Temporal (⭐18k)](https://github.com/temporalio/temporal) ⭐ 18,279 | 🐛 647 | 🌐 Go | 📅 2026-02-12 - Open-source workflow-as-code platform designed for building reliable, scalable, and fault-tolerant applications.
* [Argo Workflows (⭐16k)](https://github.com/argoproj/argo-workflows) ⭐ 16,450 | 🐛 1,371 | 🌐 Go | 📅 2026-02-12 - Container-native workflow engine designed for orchestrating parallel jobs in Kubernetes-based, cloud-native environments.
...
* [Activiti (⭐10k)](https://github.com/Activiti/Activiti) ⭐ 10,520 | 🐛 670 | 🌐 Java | 📅 2026-02-11 - Lightweight, Java-centric BPMN engine that efficiently executes business workflows with a focus on simplicity.
* [Cadence (⭐9.1k)](https://github.com/uber/cadence) ⭐ 9,173 | 🐛 188 | 🌐 Go | 📅 2026-02-11 - Fault-tolerant, stateful platform that reliably orchestrates long-running workflows and complex applications.
* [Flowable (⭐9k)](https://github.com/flowable/flowable-engine) ⭐ 9,079 | 🐛 385 | 🌐 Java | 📅 2026-02-04 - Compact, efficient set of open-source engines for automating and scaling enterprise workflows.
* [Elsa Core (⭐7.6k)](https://github.com/elsa-workflows/elsa-core) ⭐ 7,615 | 🐛 785 | 🌐 C# | 📅 2026-02-11 - .NET Core library that integrates seamlessly into any application to execute and manage workflows.
...
* [Azkaban (⭐4.5k)](https://github.com/azkaban/azkaban) ⭐ 4,517 | 🐛 802 | 🌐 Java | 📅 2024-07-03 - Distributed scheduler that simplifies managing job dependencies in large-scale data processing environments.
...
* [OpenAPI (ex.Swagger) (⭐30k)](https://github.com/OAI/OpenAPI-Specification) ⭐ 30,910 | 🐛 113 | 🌐 Markdown | 📅 2026-02-11 - A language-agnostic specification for creating RESTful APIs that enables both humans and machines to understand the capabilities of a service without the need for source code or documentation.
...
* [CloudEvents (⭐5.6k)](https://github.com/cloudevents/spec) ⭐ 5,678 | 🐛 25 | 🌐 Python | 📅 2025-12-04 -  A specification for describing event data in common formats to provide interoperability across services, platforms and systems.
* [AsyncAPI (⭐5k)](https://github.com/asyncapi/spec) ⭐ 5,090 | 🐛 40 | 🌐 JavaScript | 📅 2026-01-31 - An essential tool for developing Event-Driven Architectures (EDA) and enables engineers to build a better tooling ecosystem.
...
* [API-Security-Checklist (⭐23k)](https://github.com/shieldfy/API-Security-Checklist) ⭐ 23,173 | 🐛 1 | 📅 2026-02-10 - Best practices about REST API security.
...
* [JSON Schema (⭐4.8k)](https://github.com/json-schema-org/json-schema-spec) ⭐ 4,843 | 🐛 61 | 🌐 JavaScript | 📅 2026-02-10 - A powerful tool for validating the structure of JSON data. JSON Schema enables developers to ensure that JSON data conforms to a specific structure, making it easier to process and manipulate.
